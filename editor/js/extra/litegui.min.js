...
document.createElement("div");this.modalbg_div.className="litemodalbg";this.root.appendChild(this.modalbg_div);a.style.display="none";a=document.createElement("div");a.className="litegui-maincontent";this.content=a;this.root.appendChild(a);c.menubar&&this.createMenubar();c.gui_callback&&c.gui_callback();this.root.classList.contains("fullscreen")&&window.addEventListener("resize",function(a){LiteGUI.maximizeWindow()});window.addEventListener("beforeunload",function(a){for(var e in LiteGUI.windows)LiteGUI.windows[e].close();
LiteGUI.windows=[]})},trigger:function(c,a,b,e){var d=document.createEvent("CustomEvent");d.initCustomEvent(a,!0,!0,b);d.srcElement=e;c.dispatchEvent?c.dispatchEvent(d):c.__events&&c.__events.dispatchEvent(d);return d},bind:function(c,a,b){function e(e){if(e.addEventListener)e.addEventListener(a,b);else{if(!e.__events){var c=document.createElement("span");c.widget=e;Object.defineProperty(e,"__events",{enumerable:!1,configurable:!1,writable:!1,value:c})}e.__events.addEventListener(a,b)}}if(!c)throw"Cannot bind to null";
if(!a)throw"Event bind missing";if(!b)throw"Bind callback missing";c.constructor===String&&(c=document.querySelectorAll(c));if(c.constructor===NodeList||c.constructor===Array)for(var d=0;d<c.length;++d)e(c[d]);else e(c)},unbind:function(c,a,b){c.removeEventListener?c.removeEventListener(a,b):c.__events&&c.__events.removeEventListener&&c.__events.removeEventListener(a,b)},add:function(c){this.content.appendChild(c.root||c)},remove:function(c){if(c){if(c.constructor===String)for(var a=document.querySelectorAll(c),
...
b.height=a+"px",b.boxShadow="0 0 4px black",this.root.classList.remove("fullscreen");else{if(this.root.classList.contains("fullscreen"))return;this.root.classList.add("fullscreen");b.width="100%";b.height="100%";b.boxShadow="0 0 0"}LiteGUI.trigger(LiteGUI,"resized")},maximizeWindow:function(){this.setWindowSize()},setCursor:function(c){this.root.style.cursor=c},isCursorOverElement:function(c,a){var b=c.pageX,e=c.pageY,d=a.getBoundingClientRect();return d?e>d.top&&e<d.top+d.height&&b>d.left&&b<d.left+
d.width?!0:!1:!1},getRect:function(c){return c.getBoundingClientRect()},toClipboard:function(c,a){c&&c.constructor!==String&&(c=JSON.stringify(c));var b=null,e=!1;if(!a)try{document.queryCommandSupported("copy"),b=document.createElement("input"),b.type="text",b.style.opacity=0,b.value=c,document.body.appendChild(b),b.select(),e=document.execCommand("copy"),console.log(e?"saved to clipboard":"problem saving to clipboard"),document.body.removeChild(b)}catch(d){b&&document.body.removeChild(b),console.warn("Oops, unable to copy using the true clipboard")}try{this._safe_cliboard=
null,localStorage.setItem("litegui_clipboard",c)}catch(f){this._safe_cliboard=c,console.warn("cliboard quota excedeed")}},getLocalClipboard:function(){var c=localStorage.getItem("litegui_clipboard");!c&&this._safe_cliboard&&(c=this._safe_cliboard);return c?"{"==c[0]?JSON.parse(c):c:null},addCSS:function(c){if(c)if(c.constructor===String){var a=document.createElement("style");a.type="text/css";a.innerHTML=c;document.getElementsByTagName("head")[0].appendChild(a)}else for(a in c)document.body.style[a]=
c[a]},requireCSS:function(c,a){for("string"==typeof c&&(c=[c]);c.length;){var b=document.createElement("link");b.rel="stylesheet";b.type="text/css";b.href=c.shift(1);b.media="all";document.getElementsByTagName("head")[0].appendChild(b);0==c.length&&(b.onload=a)}},request:function(c){var a=c.dataType||"text";"json"==a?a="text":"xml"==a?a="text":"binary"==a&&(a="arraybuffer",c.mimeType="application/octet-stream");var b=new XMLHttpRequest;b.open(c.data?"POST":"GET",c.url,!0);a&&(b.responseType=a);c.mimeType&&
b.overrideMimeType(c.mimeType);c.nocache&&b.setRequestHeader("Cache-Control","no-cache");b.onload=function(a){a=this.response;if(200!=this.status)a="Error "+this.status,c.error&&c.error(a),LEvent.trigger(b,"fail",this.status);else{if("json"==c.dataType)try{a=JSON.parse(a)}catch(e){if(c.error)c.error(e);else throw e;}else if("xml"==c.dataType)try{a=(new DOMParser).parseFromString(a,"text/xml")}catch(g){if(c.error)c.error(g);else throw g;}c.success&&c.success.call(this,a,this)}};b.onerror=function(a){c.error&&
c.error(a)};a=new FormData;if(c.data)for(var e in c.data)a.append(e,c.data[e]);b.send(a);return b},requestText:function(c,a,b){return this.request({url:c,dataType:"text",success:a,error:b})},requestJSON:function(c,a,b){return this.request({url:c,dataType:"json",success:a,error:b})},requestBinary:function(c,a,b){return this.request({url:c,dataType:"binary",success:a,error:b})},requireScript:function(c,a,b,e,d){if(!c)throw"invalid URL";c.constructor===String&&(c=[c]);var f=c.length,g=[],h;for(h in c){var k=
document.createElement("script");k.num=h;k.type="text/javascript";k.src=c[h]+(d?"?version="+d:"");k.original_src=c[h];k.async=!1;k.onload=function(b){f--;g.push(this);f?e&&e(this.original_src,this.num):a&&a(g)};b&&(k.onerror=function(a){b(a,this.original_src,this.num)});document.getElementsByTagName("head")[0].appendChild(k)}},requireScriptSerial:function(c,a,b){function e(){var f=document.createElement("script");f.type="text/javascript";f.src=c.shift(1);f.onload=function(f){c.length?(b&&b(c[0],c.length),
e()):(d.push(this),a&&a(d))};document.getElementsByTagName("head")[0].appendChild(f)}"string"==typeof c&&(c=[c]);var d=[];e()},newDiv:function(c,a){return this.createElement("div",c,a)},createElement:function(c,a,b,e,d){c=document.createElement(c);if(a){a=a.split(" ");for(var f=0;f<a.length;f++)"."==a[f][0]?c.classList.add(a[f].substr(1)):c.id="#"==a[f][0]?a[f].substr(1):a[f]}c.root=c;b&&(c.innerHTML=b);c.add=function(a){this.appendChild(a.root||a)};if(e)if(e.constructor===String)c.setAttribute("style",
e);else for(f in e)c.style[f]=e[f];if(d)for(f in d)c.addEventListener(f,d[f]);return c},createButton:function(c,a,b,e){var d=document.createElement("button");d.className="litegui litebutton button";if(c){c=c.split(" ");for(var f=0;f<c.length;f++)"."==c[f][0]?d.classList.add(c[f].substr(1)):d.id="#"==c[f][0]?c[f].substr(1):c[f]}d.root=d;void 0!==a&&(d.innerHTML=a);b&&d.addEventListener("click",b);if(e)if(e.constructor===String)d.setAttribute("style",e);else for(f in e)d.style[f]=e[f];return d},newWindow:function(c,
a,b,e){e=e||{};a=window.open("","","width="+a+", height="+b+", location=no, status=no, menubar=no, titlebar=no, fullscreen=yes");a.document.write("<html><head><title>"+c+"</title>");b=document.querySelectorAll("link[rel='stylesheet'],style");for(c=0;c<b.length;c++)a.document.write(b[c].outerHTML);if(e.scripts)for(b=document.querySelectorAll("script"),c=0;c<b.length;c++)b[c].src&&a.document.write(b[c].outerHTML);a.document.write("</head><body>"+(e.content||"")+"</body></html>");a.document.close();
return a},showModalBackground:function(c){LiteGUI.modalbg_div&&(LiteGUI.modalbg_div.style.display=c?"block":"none")},showMessage:function(c,a){a=a||{};a.title=a.title||"Attention";a.content=c;a.close="fade";var b=new LiteGUI.Dialog(a);a.noclose||b.addButton("Close",{close:!0});b.makeModal("fade");return b},popup:function(c,a){a=a||{};a.min_height=140;"string"==typeof c&&(c="<p>"+c+"</p>");a.content=c;a.close="fade";var b=new LiteGUI.Dialog(a);a.noclose||b.addButton("Close",{close:!0});b.show();return b},
alert:function(c,a){a=a||{};a.className="alert";a.title=a.title||"Alert";a.width=a.width||280;a.height=a.height||140;"string"==typeof c&&(c="<p>"+c+"</p>");LiteGUI.remove(".litepanel.alert");return LiteGUI.showMessage(c,a)},confirm:function(c,a,b){function e(b){b="yes"==this.dataset.value;d.close();a&&a(b)}b=b||{};b.className="alert";b.title=b.title||"Confirm";b.width=b.width||280;"string"==typeof c&&(c="<p>"+c+"</p>");b.noclose=!0;var d=this.showMessage(c+"<button class='litebutton' data-value='yes' style='width:45%; margin-left: 10px'>Yes</button><button class='litebutton' data-value='no' style='width:45%'>No</button>",
b);d.content.style.paddingBottom="10px";c=d.content.querySelectorAll("button");for(b=0;b<c.length;b++)c[b].addEventListener("click",e);return d},prompt:function(c,a,b){function e(){var b=h.value;this.dataset&&"cancel"==this.dataset.value&&(b=null);g.close();a&&a(b)}b=b||{};b.className="alert";b.title=b.title||"Prompt";b.width=b.width||280;"string"==typeof c&&(c="<p>"+c+"</p>");var d=b.value||"",f="<input type='text' value='"+d+"'/>";b.textarea&&(f="<textarea class='textfield' style='width:95%'>"+
d+"</textarea>");b.noclose=!0;var g=this.showMessage(c+("<p>"+f+"</p><button class='litebutton' data-value='accept' style='width:45%; margin-left: 10px; margin-bottom: 10px'>Accept</button><button class='litebutton' data-value='cancel' style='width:45%'>Cancel</button>"),b);c=g.content.querySelectorAll("button");for(b=0;b<c.length;b++)c[b].addEventListener("click",e);var h=g.content.querySelector("input,textarea");h.addEventListener("keydown",function(a){a||(a=window.event);a=a.keyCode||a.which;if("13"==
a)return e(),!1;"29"==a&&g.close()},!0);h.focus();return g},choice:function(c,a,b,e){function d(e){e=a[this.dataset.value];g.close();b&&b(e)}e=e||{};e.className="alert";e.title=e.title||"Select one option";e.width=e.width||280;"string"==typeof c&&(c="<p>"+c+"</p>");for(var f in a)c+="<button class='litebutton' data-value='"+f+"' style='width:45%; margin-left: 10px'>"+(a[f].content||a[f])+"</button>";e.noclose=!0;var g=this.showMessage(c,e);g.content.style.paddingBottom="10px";c=g.content.querySelectorAll("button");
for(f=0;f<c.length;f++)c[f].addEventListener("click",d);return g},downloadURL:function(c,a){var b=document.createElement("a");b.href=c;b.download=a;document.body.appendChild(b);b.click();document.body.removeChild(b)},downloadFile:function(c,a,b){if(a){b||(b=a.constructor===String?"text/plain":"application/octet-stream");var e=null,e=a.constructor!==File&&a.constructor!==Blob?new Blob([a],{type:b}):a,d=URL.createObjectURL(e);a=document.createElement("a");a.setAttribute("href",d);a.setAttribute("download",
c);a.style.display="none";document.body.appendChild(a);a.click();document.body.removeChild(a);setTimeout(function(){URL.revokeObjectURL(d)},6E4)}else console.warn("No file provided to download")},getUrlVars:function(){for(var c=[],a,b=window.location.href.slice(window.location.href.indexOf("?")+1).split("&"),e=0;e<b.length;e++)a=b[e].split("="),c.push(a[0]),c[a[0]]=a[1];return c},getUrlVar:function(c){return LiteGUI.getUrlVars()[c]},focus:function(c){c.focus()},blur:function(c){c.blur()},draggable:function(c,
a,b,e,d){function f(a){if("mousedown"==a.type){k||(l=(k=c.getClientRects()[0])?k.left:0,n=k?k.top:0);if(d&&!1==d(c,a))return a.stopPropagation(),a.preventDefault(),!1;g=a.clientX;h=a.clientY;document.addEventListener("mousemove",f);document.addEventListener("mouseup",f);b&&b(c,a);a.stopPropagation();a.preventDefault();return!1}if("mouseup"==a.type)document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",f),e&&e(c,a);else if("mousemove"==a.type){var m=a.clientX-g,q=a.clientY-
h;g=a.clientX;h=a.clientY;l+=m;n+=q;c.style.left=l+"px";c.style.top=n+"px"}}a=a||c;a.addEventListener("mousedown",f);a.style.cursor="move";var g=0,h=0,k=c.getClientRects()[0],l=k?k.left:0,n=k?k.top:0;c.style.position="absolute";c.style.left=l+"px";c.style.top=n+"px"},cloneObject:function(c,a){var b=a||{},e;for(e in c)if("_"!=e[0]&&"jQuery"!=e.substr(0,6)){var d=c[e];if(null==d)b[e]=null;else if(!isFunction(d))if("number"==typeof d||"string"==typeof d)b[e]=d;else if(d.constructor==Float32Array)b[e]=
Array.apply([],d);else if(isArray(d))b[e]&&b[e].constructor==Float32Array?b[e].set(d):b[e]=JSON.parse(JSON.stringify(d));else try{b[e]=JSON.parse(JSON.stringify(d))}catch(f){console.error(f)}}return b},safeName:function(c){return String(c).replace(/[\s\.]/g,"")},special_codes:{close:"&#10005;",navicon:"&#9776;",refresh:"&#8634;",gear:"&#9881;",open_folder:"&#128194;"},htmlEncode:function(c){var a=document.createElement("div");a.innerHTML=c;return a.innerText},htmlDecode:function(c){var a=document.createElement("div");
a.innerText=c;return a.innerHTML},sizeToCSS:function(c){return void 0===c||null===c?null:c.constructor===String?c:0<=c?(c|0)+"px":"calc( 100% - "+Math.abs(c|0)+"px )"},createDropArea:function(c,a,b,e){function d(a){c.addEventListener("dragexit",d);c.addEventListener("dragover",d);c.addEventListener("drop",f);a.stopPropagation();a.preventDefault();"dragenter"==a.type&&b&&b(a,this);"dragexit"==a.type&&e&&e(a,this)}function f(b){b.stopPropagation();b.preventDefault();c.removeEventListener("dragexit",
d);c.removeEventListener("dragover",d);c.removeEventListener("drop",f);var e=void 0;a&&(e=a(b));if(e)return b.stopPropagation(),b.stopImmediatePropagation(),!0}c.addEventListener("dragenter",d)}};Object.defineProperty(String.prototype,"template",{value:function(c,a){for(var b=this,e=/{{([^}}]+)?}}/g,d;d=e.exec(b);)var f=a?(new Function("with(this) { try { return "+d[1]+"} catch(e) { return 'error';} }")).call(c):c[d[1]],b=b.replace(d[0],f);return b},enumerable:!1});
...
b+"</span>":b});c=c.replace(/([0-9]+)/g,function(a){return"<span class='num'>"+a+"</span>"});c=c.replace(/(\w+\.\w+)/g,function(a){a=a.split(".");return"<span class='obj'>"+a[0]+"</span>.<span class='prop'>"+a[1]+"</span>"});c=c.replace(/(\w+)\(/g,function(a){return"<span class='prop'>"+a.substr(0,a.length-1)+"</span>("});c=c.replace(/(\"(\\.|[^\"])*\")/g,function(a){return"<span class='str'>"+a+"</span>"});c=c.replace(/(\/\/[a-zA-Z0-9\?\!\(\)_ ]*)/g,function(a){return"<span class='cmnt'>"+a+"</span>"});
...
(function(){function c(a,b){b=b||{};var c=document.createElement("div");c.className="litegui searchbox";c.innerHTML="<input value='"+a+"' placeholder='"+(null!=b.placeholder?b.placeholder:"Search")+"'/>";this.input=c.querySelector("input");this.root=c;var g=this;$(this.input).change(function(a){a=a.target.value;b.callback&&b.callback.call(g,a)})}function a(a,b){this.options=b=b||{};var c=this;b.parentMenu&&(b.parentMenu.constructor!==this.constructor?(console.error("parentMenu must be of class ContextMenu, ignoring it"),
b.parentMenu=null):(this.parentMenu=b.parentMenu,this.parentMenu.lock=!0,this.parentMenu.current_submenu=this));b.event&&b.event.constructor!==MouseEvent&&b.event.constructor!==CustomEvent&&(console.error("Event passed to ContextMenu is not of type MouseEvent or CustomEvent. Ignoring it."),b.event=null);var g=document.createElement("div");g.className="litecontextmenu litemenubar-panel";g.style.minWidth=100;g.style.minHeight=100;g.style.pointerEvents="none";setTimeout(function(){g.style.pointerEvents=
"auto"},100);g.addEventListener("mouseup",function(a){a.preventDefault();return!0},!0);g.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);g.addEventListener("mousedown",function(a){if(2==a.button)return c.close(),a.preventDefault(),!0},!0);this.root=g;if(b.title){var h=document.createElement("div");h.className="litemenu-title";h.innerHTML=b.title;g.appendChild(h)}var h=0,k;for(k in a){var l=a.constructor==Array?a[k]:k;null!=l&&l.constructor!==String&&
(l=void 0===l.content?String(l):l.content);this.addItem(l,a[k],b);h++}g.addEventListener("mouseleave",function(a){c.lock||c.close(a)});k=document;b.event&&(k=b.event.target.ownerDocument);k||(k=document);k.body.appendChild(g);h=b.left||0;k=b.top||0;if(b.event)if(b.event.constructor!==MouseEvent&&b.event.constructor!==CustomEvent)console.warn("Event passed to ContextMenu is not of type MouseEvent"),b.event=null;else{h=b.event.pageX-10;k=b.event.pageY-10;b.title&&(k-=20);b.parentMenu&&(h=b.parentMenu.root.getBoundingClientRect(),
h=h.left+h.width);var l=document.body.getBoundingClientRect(),n=g.getBoundingClientRect();h>l.width-n.width-10&&(h=l.width-n.width-10);k>l.height-n.height-10&&(k=l.height-n.height-10)}g.style.left=h+"px";g.style.top=k+"px"}function b(a,b,c){c=c||{};var g=this.root=document.createElement("ul");g.id=a;g.className="litelist";this.items=[];var h=this;this.callback=c.callback;for(var k in b){a=document.createElement("li");a.className="list-item";a.data=b[k];a.dataset.value=b[k];var l="";"string"==typeof b[k]?
...
var c=this,g=document.createElement("div");g.className="litegui button";this.root=g;var h=document.createElement("button");h.className="litebutton";this.content=h;g.appendChild(h);h.innerHTML=a;h.addEventListener("click",function(a){c.click()});this.click=function(){b.callback&&b.callback.call(c)}};c.prototype.setValue=function(a){$(this.input).val(a).change()};c.prototype.getValue=function(){return $(this.input).val()};LiteGUI.SearchBox=c;a.prototype.addItem=function(a,b,c){function g(a){var b=this.value;
b&&b.has_submenu&&h.call(this,a)}function h(a){var b=this.value,e=!0;k.current_submenu&&k.current_submenu.close(a);if(c.callback){var d=c.callback.call(k,b,c,a);!0===d&&(e=!1)}if(b&&(b.callback&&!c.ignore_item_callbacks&&!0!==b.disabled&&(d=b.callback.call(this,b,c,a,k),!0===d&&(e=!1)),b.submenu)){if(!b.submenu.options)throw"ContextMenu submenu needs options";new LiteGUI.ContextMenu(b.submenu.options,{callback:b.submenu.callback,event:a,parentMenu:k,ignore_item_callbacks:b.submenu.ignore_item_callbacks,
title:b.submenu.title,autoopen:c.autoopen});e=!1}e&&!k.lock&&k.close()}var k=this;c=c||{};var l=document.createElement("div");l.className="litemenu-entry submenu";var n=!1;if(null===b)l.classList.add("separator");else{l.innerHTML=b&&b.title?b.title:a;if(l.value=b)b.disabled&&(n=!0,l.classList.add("disabled")),(b.submenu||b.has_submenu)&&l.classList.add("has_submenu");"function"==typeof b?(l.dataset.value=a,l.onclick_callback=b):l.dataset.value=b}this.root.appendChild(l);n||l.addEventListener("click",
h);c.autoopen&&l.addEventListener("mouseenter",g);return l};a.prototype.close=function(a,b){this.root.parentNode&&this.root.parentNode.removeChild(this.root);this.parentMenu&&!b&&(this.parentMenu.lock=!1,this.parentMenu.current_submenu=null,void 0===a?this.parentMenu.close():a&&!LiteGUI.isCursorOverElement(a,this.parentMenu.root)&&LiteGUI.trigger(this.parentMenu.root,"mouseleave",a));this.current_submenu&&this.current_submenu.close(a,!0)};a.prototype.getTopMenu=function(){return this.options.parentMenu?
this.options.parentMenu.getTopMenu():this};a.prototype.getFirstEvent=function(){return this.options.parentMenu?this.options.parentMenu.getFirstEvent():this.options.event};LiteGUI.ContextMenu=a;LiteGUI.ContextualMenu=a;LiteGUI.Checkbox=function(a,b){this.value=a;var c=this.root=document.createElement("span");c.className="litecheckbox inputfield";c.dataset.value=a;var g=this.element=document.createElement("span");g.className="fixed flag checkbox "+(a?"on":"off");c.appendChild(g);c.addEventListener("click",
function(a){this.setValue("true"!=this.root.dataset.value);a.preventDefault();a.stopPropagation()}.bind(this));this.setValue=function(a){if(this.value!==a&&this.root.dataset.value!=a.toString()){(this.root.dataset.value=a)?(this.element.classList.remove("off"),this.element.classList.add("on")):(this.element.classList.remove("on"),this.element.classList.add("off"));var c=this.value;this.value=a;b&&b(a,c)}};this.getValue=function(){return this.value}};LiteGUI.createLitebox=function(a,b){var c=document.createElement("span");
c.className="listbox "+(a?"listopen":"listclosed");c.innerHTML=a?"&#9660;":"&#9658;";c.dataset.value=a?"open":"closed";c.addEventListener("click",function(a){a.target.setValue("open"==this.dataset.value?!1:!0);this.stopPropagation&&a.stopPropagation()});c.on_change_callback=b;c.setEmpty=function(a){a?this.classList.add("empty"):this.classList.remove("empty")};c.expand=function(){this.setValue(!0)};c.collapse=function(){this.setValue(!1)};c.setValue=function(a){this.dataset.value!=(a?"open":"closed")&&
(a?(this.dataset.value="open",this.innerHTML="&#9660;",this.classList.add("listopen"),this.classList.remove("listclosed")):(this.dataset.value="closed",this.innerHTML="&#9658;",this.classList.remove("listopen"),this.classList.add("listclosed")),b&&b(this.dataset.value))};c.getValue=function(){return this.dataset.value};return c};b.prototype.getSelectedItem=function(){return this.root.querySelector(".list-item.selected")};b.prototype.setSelectedItem=function(a){for(var b=this.root.querySelectorAll(".list-item"),
c=0;c<b.length;c++){var g=b[c];if(g.data==a){LiteGUI.trigger(g,"click");break}}};LiteGUI.List=b;LiteGUI.Slider=function(a,b){function c(a){var e=k.getClientRects()[0].width,f=b.min||0;l.setValue(a/e*((b.max||1)-f)+f)}function g(a){var b=k.getClientRects()[0];c((void 0===a.x?a.pageX:a.x)-b.left);a.preventDefault();return!1}function h(a){var b=n||document;n=null;b.removeEventListener("mousemove",g);b.removeEventListener("mouseup",h);a.preventDefault();return!1}b=b||{};var k=document.createElement("canvas");
k.className="slider "+(b.extraclass?b.extraclass:"");k.width=100;k.height=1;k.style.position="relative";k.style.width="calc( 100% - 2em )";k.style.height="1.2em";this.root=k;var l=this;this.value=a;this.setValue=function(a,c){var e=k.getContext("2d"),f=b.min||0,g=b.max||1;a<f?a=f:a>g&&(a=g);f=(a-f)/(g-f);e.clearRect(0,0,k.width,k.height);e.fillStyle="#999";e.fillRect(0,0,k.width*f,k.height);e.fillStyle="#DA2";e.fillRect(k.width*f-1,0,2,k.height);if(a!=this.value&&(this.value=a,!c&&(LiteGUI.trigger(this.root,
"change",a),this.onChange)))this.onChange(a)};var n=null;k.addEventListener("mousedown",function(a){var b;a.offsetX?b=a.offsetX:a.layerX&&(b=a.layerX);c(b);n=k.ownerDocument;n.addEventListener("mousemove",g);n.addEventListener("mouseup",h)});this.setValue(a)};LiteGUI.LineEditor=function(a,b){function c(a){return[q.width*((m.xrange[1]-m.xrange[0])*a[0]+m.xrange[0]),q.height*((m.yrange[1]-m.yrange[0])*a[1]+m.yrange[0])]}function g(a){return[(a[0]/q.width-m.xrange[0])/(m.xrange[1]-m.xrange[0]),(a[1]/
q.height-m.yrange[0])/(m.yrange[1]-m.yrange[0])]}function h(a){var b=q.getBoundingClientRect(),c=a.clientX-b.left,e=a.clientY-b.top;0>c?c=0:c>q.width&&(c=q.width);0>e?e=0:e>q.height&&(e=q.height);if(-1!=r&&n([a.clientX-b.left,a.clientY-b.top],[c,e])>0.5*q.height)m.value.splice(r,1),k(a);else{b=g([-(s[0]-c),s[1]-e]);if(-1!=r){var d=m.xrange[0],f=m.xrange[1];m.no_trespassing&&(0<r&&(d=m.value[r-1][0]),r<m.value.length-1&&(f=m.value[r+1][0]));var h=m.value[r];h[0]+=b[0];h[1]+=b[1];h[0]<d?h[0]=d:h[0]>
f&&(h[0]=f);h[1]<m.yrange[0]?h[1]=m.yrange[0]:h[1]>m.yrange[1]&&(h[1]=m.yrange[1])}p();m.redraw();s[0]=c;s[1]=e;l();a.preventDefault();a.stopPropagation()}}function k(a){r=-1;m.redraw();$(document).unbind("mousemove",h);$(document).unbind("mouseup",k);l();a.preventDefault();a.stopPropagation()}function l(){b.callback?b.callback.call(m,m.value):$(m).change()}function n(a,b){return Math.sqrt(Math.pow(b[0]-a[0],2)+Math.pow(b[1]-a[1],2))}function p(){var a=null;-1!=r&&(a=m.value[r]);m.value.sort(function(a,
b){return a[0]>b[0]});a&&(r=m.value.indexOf(a))}b=b||{};var m=document.createElement("div");m.className="curve "+(b.extraclass?b.extraclass:"");m.style.minHeight="50px";m.style.width=b.width||"100%";m.bgcolor=b.bgcolor||"#222";m.pointscolor=b.pointscolor||"#5AF";m.linecolor=b.linecolor||"#444";m.value=a||[];m.xrange=b.xrange||[0,1];m.yrange=b.yrange||[0,1];m.defaulty=null!=b.defaulty?b.defaulty:0.5;m.no_trespassing=b.no_trespassing||!1;m.show_samples=b.show_samples||0;m.options=b;var q=document.createElement("canvas");
q.width=b.width||200;q.height=b.height||50;m.appendChild(q);m.canvas=q;$(q).bind("mousedown",function(a){$(document).bind("mousemove",h);$(document).bind("mouseup",k);for(var b=q.getBoundingClientRect(),e=a.clientX-b.left,b=a.clientY-b.top,d=q.height-b,l=1E5,A=-1,x=0;x<m.value.length;x++){var w=c(m.value[x]),w=n([e,d],w);w<l&&8>w&&(l=w,A=x)}r=A;-1==r&&(d=g([e,q.height-b]),m.value.push(d),p(),r=m.value.indexOf(d));s=[e,b];m.redraw();a.preventDefault();a.stopPropagation()});$(m).resize(function(a){q.width=
$(this).width();q.height=$(this).height();m.redraw()});m.getValueAt=function(a){if(a<m.xrange[0]||a>m.xrange[1])return m.defaulty;for(var b=[m.xrange[0],m.defaulty],c=0,c=0;c<m.value.length;c+=1){var e=m.value[c];if(a==e[0])return e[1];if(a<e[0])return c=(a-b[0])/(e[0]-b[0]),b[1]*(1-c)+e[1]*c;b=e}e=[m.xrange[1],m.defaulty];c=(a-b[0])/(e[0]-b[0]);return b[1]*(1-c)+e[1]*c};m.resample=function(a){var b=[];a=(m.xrange[1]-m.xrange[0])/a;for(var c=m.xrange[0];c<=m.xrange[1];c+=a)b.push(m.getValueAt(c));
return b};m.addValue=function(a){for(var b=0;b<m.value;b++)if(!(m.value[b][0]<a[0])){m.value.splice(b,0,a);redraw();return}m.value.push(a);redraw()};var r=-1;m.redraw=function(){var a=q.getContext("2d");a.setTransform(1,0,0,1,0,0);a.translate(0,q.height);a.scale(1,-1);a.fillStyle=m.bgcolor;a.fillRect(0,0,q.width,q.height);a.strokeStyle=m.linecolor;a.beginPath();var b=c([m.xrange[0],m.defaulty]);a.moveTo(b[0],b[1]);for(var e in m.value)b=m.value[e],b=c(b),a.lineTo(b[0],b[1]);b=c([m.xrange[1],m.defaulty]);
a.lineTo(b[0],b[1]);a.stroke();for(e=0;e<m.value.length;e+=1)b=m.value[e],b=c(b),a.fillStyle=r==e?"white":m.pointscolor,a.beginPath(),a.arc(b[0],b[1],r==e?4:2,0,2*Math.PI),a.fill();if(m.show_samples){var d=m.resample(m.show_samples);a.fillStyle="#888";for(e=0;e<d.length;e+=1)b=[(m.xrange[1]-m.xrange[0])/m.show_samples*e+m.xrange[0],d[e]],b=c(b),a.beginPath(),a.arc(b[0],b[1],2,0,2*Math.PI),a.fill()}};var s=[0,0];m.redraw();return m}})();
...
h.root.appendChild(this.content);h.content=this.content;this.root.appendChild(h.root);n&&this.root.appendChild(n);this.root.appendChild(k.root);this.sections=[h,k];this.dynamic_section=p;this.direction=a;var m=this,q=[0,0]};c.prototype.hide=function(){this.root.style.display="none"};c.prototype.show=function(){this.root.style.display="block"};c.prototype.showSection=function(a){var b=this.sections[a],c=0;if(!b||"none"==b.root.style.display){c="horizontal"==this.direction?b.root.style.width:b.root.style.height;
...
[];this._computed_size=null;this.onResize()};c.prototype.add=function(a){if("string"==typeof a){var b=document.createElement("div");b.innerHTML=a;a=b}this.content.appendChild(a.root||a)};c.prototype.query=function(a){return this.root.querySelector(a)};LiteGUI.Area=c;LiteGUI.Split=function(a,b,c){c=c||{};var d=document.createElement("div");this.root=d;d.id=a;d.className="litesplit "+(c.vertical?"vsplit":"hsplit");this.sections=[];for(var f in b)a=document.createElement("div"),a.className="split-section split"+
f,"number"==typeof b[f]?c.vertical?a.style.height=b[f].toFixed(1)+"%":a.style.width=b[f].toFixed(1)+"%":"string"==typeof b[f]?c.vertical?a.style.height=b[f]:a.style.width=b[f]:(b[f].id&&(a.id=b[f].id),c.vertical?a.style.height="Number"==typeof b[f].height?b[f].height.toFixed(1)+"%":b[f].height:a.style.width="Number"==typeof b[f].width?b[f].width.toFixed(1)+"%":b[f].width),a.add=function(a){this.appendChild(a.root||a)},this.sections.push(a),d.appendChild(a);c.parent&&(c.parent.root?c.parent.root.appendChild(d):
c.parent.appendChild(d));this.getSection=function(a){return this.sections[a]}}})();
...
h[k];a.className="litemenu-entry "+(a.children?" submenu":"");var n=l.children&&l.children.length;n&&a.classList.add("has_submenu");l&&l.name?a.innerHTML="<span class='icon'></span><span class='name'>"+l.name+(n?"<span class='more'>+</span>":"")+"</span>":a.classList.add("separator");a.data=l;if(a.data.data){l=a.data.data;if("checkbox"==l.type&&l.instance&&l.property&&!0==l.instance[l.property]||!0==l.checkbox||l.instance&&l.property&&l.hasOwnProperty("value")&&l.instance[l.property]==l.value||"function"==
...
function(a){if(!this.classList.contains("selected")&&this.parentNode){var b=this.options,c=this.parentNode.parentNode.tabs;if(!c)throw"tabs not found";if(!b.callback_canopen||!1!=b.callback_canopen()){c.current_tab&&c.current_tab[0]!=d&&c.current_tab[2]&&c.current_tab[2].callback_leave&&c.current_tab[2].callback_leave(c.current_tab[0],c.current_tab[1],c.current_tab[2]);var d=this.dataset.id,f=null,g;for(g in c.tabs){var h=c.tabs[g];g==d?(h.selected=!0,h.content.style.display="",f=h.content):(delete h.selected,
h.content.style.display="none")}$(c.list).find("li.wtab").removeClass("selected");this.classList.add("selected");c.previous_tab=c.current_tab;c.current_tab=[d,f,b];if(a&&(b.callback&&b.callback(d,f,a),$(c).trigger("wchange",[d,f]),c.onchange))c.onchange(d,f);c.selected=d}}};c.prototype.selectTab=function(a,b){if(a){a.constructor!=String&&(a=a.id);for(var c=this.list.querySelectorAll("li.wtab"),d=0;d<c.length;d++)if(a==c[d].dataset.id){this.onTabClicked.call(c[d],!b);break}}};c.prototype.setTabVisibility=
function(a,b){var c=this.tabs[a];c&&(c.tab.style.display=b?"none":null,c.content.style.display=b?"none":null)};c.prototype.recomputeTabsByIndex=function(){this.tabs_by_index=[];for(var a in this.tabs){for(var b=this.tabs[a],c=0,d=b.tab;null!=(d=d.previousSibling);)c++;this.tabs_by_index[c]=b}};c.prototype.removeTab=function(a){var b=this.tabs[a];if(b){if(b.onclose)b.onclose(b);b.tab.parentNode.removeChild(b.tab);b.content.parentNode.removeChild(b.content);delete this.tabs[a];this.recomputeTabsByIndex()}};
c.prototype.removeAllTabs=function(a){var b=[],c;for(c in this.tabs)b.push(this.tabs[c]);for(c in b){var d=b[c];d==this.plus_tab&&a||(d.tab.parentNode&&d.tab.parentNode.removeChild(d.tab),d.content.parentNode&&d.content.parentNode.removeChild(d.content),delete this.tabs[d.id])}this.recomputeTabsByIndex()};c.prototype.clear=function(){this.removeAllTabs()};c.prototype.hideTab=function(a){this.setTabVisibility(a,!1)};c.prototype.showTab=function(a){this.setTabVisibility(a,!0)};c.prototype.transferTab=
function(a,b,c){var d=this.tabs[a];if(d){b.tabs[a]=d;void 0!==c?b.list.insertBefore(d.tab,b.list.childNodes[c]):b.list.appendChild(d.tab);b.root.appendChild(d.content);delete this.tabs[a];c=null;for(var f in this.tabs){c=f;break}c&&this.selectTab(c);d.tab.classList.remove("selected");b.selectTab(a)}};c.prototype.detachTab=function(a,b,c){if(this.tabs[a]){var d=this.getTabIndex(a),f=window.open("","","width=800, height=600, location=no, status=no, menubar=no, titlebar=no, fullscreen=yes");f.document.write("<head><title>"+
a+"</title>");for(var g=document.querySelectorAll("link[rel='stylesheet'],style"),h=0;h<g.length;h++)f.document.write(g[h].outerHTML);f.document.write("</head><body></body>");f.document.close();var k=this,l=new LiteGUI.Tabs(null,this.options);f.tabs=l;f.onbeforeunload=function(){l.transferTab(a,k,d);c&&c()};l.list.style.height="20px";f.document.body.appendChild(l.root);k.transferTab(a,l);l.tabs[a].tab.classList.add("selected");this.recomputeTabsByIndex();b&&b();return f}};LiteGUI.Tabs=c})();
(function(){function c(a,b){function c(a){var e=[a.screenX-m.data[0],m.data[1]-a.screenY];m.data=[a.screenX,a.screenY];g(e[b.horizontal?0:1],a);a.stopPropagation();a.preventDefault();return!1}function d(a){document.activeElement===this&&(g(0<(void 0!==a.wheelDelta?a.wheelDelta:a.deltaY?-a.deltaY/3:0)?1:-1,a),a.stopPropagation(),a.preventDefault())}function f(a){LiteGUI.trigger(k,"stop_dragging");var b=q||document;q=null;b.removeEventListener("mousemove",c);b.removeEventListener("mouseup",f);LiteGUI.trigger(m,
"blur");a.stopPropagation();a.preventDefault();return!1}function g(a,c){b.linear||(a=0<a?Math.pow(a,1.2):-1*Math.pow(Math.abs(a),1.2));var e=b.step?b.step:1;c&&c.shiftKey?e*=10:c&&c.ctrlKey&&(e*=0.1);e=parseFloat(p.value)+a*e;null!=b.max&&e>b.max&&(e=b.max);null!=b.min&&e<b.min&&(e=b.min);p.value=e.toFixed(h);b.units&&(p.value+=b.units);LiteGUI.trigger(p,"change")}null===a||void 0===a?a=0:a.constructor===String?a=parseFloat(a):a.constructor!==Number&&(a=0);this.value=a;var h=void 0!=b.precision?b.precision:
3;this.options=b||{};var k=document.createElement("div");k.className="dragger "+(b.extraclass?b.extraclass:"");this.root=k;var l=document.createElement("span");l.className="inputfield "+(b.extraclass?b.extraclass:"")+(b.full?" full":"");b.disabled&&(l.className+=" disabled");k.appendChild(l);var n=b.dragger_class||"full",p=document.createElement("input");p.className="text number "+(n?n:"");p.value=a.toFixed(h)+(b.units?b.units:"");p.tabIndex=b.tab_index;this.input=p;k.input=p;b.disabled&&(p.disabled=
!0);b.tab_index&&(p.tabIndex=b.tab_index);l.appendChild(p);p.addEventListener("keydown",function(a){if(38==a.keyCode)g(1,a);else if(40==a.keyCode)g(-1,a);else return;a.stopPropagation();a.preventDefault();return!0});var m=document.createElement("div");m.className="drag_widget";b.disabled&&(m.className+=" disabled");l.appendChild(m);k.dragger=m;m.addEventListener("mousedown",function(a){q=p.ownerDocument;q.removeEventListener("mousemove",c);q.removeEventListener("mouseup",f);b.disabled||(q.addEventListener("mousemove",
c),q.addEventListener("mouseup",f),m.data=[a.screenX,a.screenY],LiteGUI.trigger(k,"start_dragging"));a.stopPropagation();a.preventDefault()});p.addEventListener("wheel",d,!1);p.addEventListener("mousewheel",d,!1);var q=null}c.prototype.setRange=function(a,b){this.options.min=a;this.options.max=b};c.prototype.setValue=function(a,b){this.value=a=parseFloat(a);this.options.precision&&(a=a.toFixed(this.options.precision));this.options.units&&(a+=this.options.units);this.input.value=a;b||LiteGUI.trigger(this.input,
...
null))?(a.className+=" root_item",this.root_item=a):this.root_item=null};c.prototype.insertItem=function(a,b,c,d){if(!b){var f=this.root.childNodes[0];f&&(b=f.dataset.item_id)}a=this.createAndInsert(a,d,b,c);b&&this._updateListBox(this._findElement(b));return a};c.prototype.createAndInsert=function(a,b,c,d){var f=-1;c?f=this._findElementIndex(c):void 0===c&&(f=0);var g=null,h=0;-1!=f&&(g=this.root.childNodes[f],h=parseInt(g.dataset.level)+1);if(h=this.createTreeItem(a,b,h)){h.parent_id=c;this.getItem(h.dataset.item_id)&&
console.warn("There another item with the same ID in this tree");-1==f?this.root.appendChild(h):this._insertInside(h,f,d);g&&!this._isNodeChildrenVisible(c)&&h.classList.add("hidden");if(a.children)for(c=0;c<a.children.length;++c)this.createAndInsert(a.children[c],b,a.id);this._updateListBox(h,b);b&&b.selected&&this.markAsSelected(h,!0);return h}};c.prototype._insertInside=function(a,b,e,d){var f=this.root.childNodes[b];if(!f)throw"No parent node found, index: "+b+", nodes: "+this.root.childNodes.length;
...
c){for(var d=parseInt(this.root.childNodes[c].dataset.level),f=[],c=c+1;c<this.root.childNodes.length;++c){var g=this.root.childNodes[c];if(g.classList&&g.classList.contains("ltreeitem")){var h=parseInt(g.dataset.level);if(!(b&&h>d+1)){if(h<=d)break;f.push(g)}}}return f}};c.prototype.createTreeItem=function(a,b,c){function d(b){b.preventDefault();b.stopPropagation();if(!this.title_element._editing){if(b.ctrlKey&&h.options.allow_multiselection){if(h.isNodeSelected(this)){this.classList.remove("selected");
LiteGUI.trigger(h.root,"item_remove_from_selection",{item:this,data:this.data});return}h.markAsSelected(this,!0);LiteGUI.trigger(h.root,"item_add_to_selection",{item:this,data:this.data});var c=!1;a.callback&&(c=a.callback.call(h,this));if(!c&&h.onItemAddToSelection)h.onItemAddToSelection(this.data,this)}if(b.shiftKey&&h.options.allow_multiselection){if((c=h.getSelectedItem())&&c!==this){b=Array.prototype.slice.call(c.parentNode.children);var c=b.indexOf(c),e=b.indexOf(this);b=e>c?b.slice(c,e):b.slice(e,
c);for(c=0;c<b.length;++c)e=b[c],h.markAsSelected(e,!0),LiteGUI.trigger(h.root,"item_add_to_selection",{item:e,data:e.data})}}else{h.markAsSelected(this);h._skip_scroll=!0;LiteGUI.trigger(h.root,"item_selected",{item:this,data:this.data});c=!1;a.callback&&(c=a.callback.call(h,this));if(!c&&h.onItemSelected)h.onItemSelected(this.data,this);h._skip_scroll=!1}}}function f(a){var b=this,c=b.title_element.querySelector(".incontent");LiteGUI.trigger(h.root,"item_dblclicked",b);if(!c._editing&&h.options.allow_rename){c._editing=
!0;c._old_name=c.innerHTML;c.innerHTML="<input type='text' value='"+c.innerHTML+"' />";var e=c.querySelector("input");$(e).blur(function(a){var e=a.target.value;setTimeout(function(){c.innerHTML=e},1);delete c._editing;LiteGUI.trigger(h.root,"item_renamed",{old_name:c._old_name,new_name:e,item:b,data:b.data});delete c._old_name});e.addEventListener("keydown",function(a){13==a.keyCode&&$(this).blur()});$(e).focus();a.preventDefault()}a.preventDefault();a.stopPropagation()}function g(a){a.preventDefault()}
if(null===a||void 0===a)console.error("Tree item cannot be null");else{b=document.createElement("li");b.className="ltreeitem";var h=this;if(a.id){var k=a.id.replace(/\s/g,"_");b.className+=" ltreeitem-"+k;b.dataset.item_id=a.id}if(a.dataset)for(var l in a.dataset)b.dataset[l]=a.dataset[l];a.DOM=b;b.data=a;void 0!==c&&(b.dataset.level=c,b.classList.add("ltree-level-"+c));var n=document.createElement("div");n.className="ltreeitemtitle";a.className&&(n.className+=" "+a.className);n.innerHTML="<span class='precontent'></span><span class='indentblock'></span><span class='collapsebox'></span><span class='incontent'></span><span class='postcontent'></span>";
c=a.content||a.id||"";n.querySelector(".incontent").innerHTML=c;a.precontent&&(n.querySelector(".precontent").innerHTML=a.precontent);if(a.dataset)for(l in a.dataset)b.dataset[l]=a.dataset[l];b.appendChild(n);b.title_element=n;!1===a.visible&&(b.style.display="none");b.addEventListener("click",d);b.addEventListener("dblclick",f);b.addEventListener("contextmenu",function(a){a.preventDefault();a.stopPropagation();if(2==a.button)return h.onItemContextMenu?h.onItemContextMenu(a,{item:this,data:this.data}):
!1});this.options.allow_drag&&(n.draggable=!0,n.addEventListener("dragstart",function(b){b.dataTransfer.setData("item_id",this.parentNode.dataset.item_id);if(a.onDragData){var c=a.onDragData();if(c)for(var e in c)b.dataTransfer.setData(e,c[e])}}));var p=0;n.addEventListener("dragenter",function(b){b.preventDefault();if(a.skipdrag)return!1;0==p&&n.classList.add("dragover");p++});n.addEventListener("dragleave",function(a){a.preventDefault();p--;0==p&&n.classList.remove("dragover")});n.addEventListener("dragover",
g);n.addEventListener("drop",function(b){n.classList.remove("dragover");b.preventDefault();if(a.skipdrag)return!1;var c=b.dataTransfer.getData("item_id");if(c){var e=this.parentNode.dataset.item_id;(!h.onMoveItem||h.onMoveItem&&!1!=h.onMoveItem(h.getItem(c),h.getItem(e)))&&h.moveItem(c,e)&&LiteGUI.trigger(h.root,"item_moved",{item:h.getItem(c),parent_item:h.getItem(e)})}else LiteGUI.trigger(h.root,"drop_on_item",{item:this,event:b});if(h.onDropItem)h.onDropItem(b,this.parentNode.data)});return b}};
c.prototype.filterByName=function(a){for(var b=0;b<this.root.childNodes.length;++b){var e=this.root.childNodes[b];if(e.classList&&e.classList.contains("ltreeitem")){var d=e.querySelector(".incontent");if(d)if(d=d.innerHTML.toLowerCase(),a&&-1==d.indexOf(a.toLowerCase()))e.classList.add("filtered");else if(e.data&&!1!==e.data.visible&&e.classList.remove("filtered"),d=e.querySelector(".indentblock"))d.style.paddingLeft=a?0:paddingLeft=(parseInt(e.dataset.level)+this.indent_offset)*c.INDENT+"px"}}};
...
a=this.root.querySelectorAll(".ltreeitem.semiselected");for(b=0;b<a.length;b++)a[b].classList.remove("semiselected")};c.prototype.isNodeSelected=function(a){return a.classList.contains("selected")?!0:!1};c.prototype.markAsSelected=function(a,b){if(!a.classList.contains("selected")){b||this.unmarkAllAsSelected();a.classList.add("selected");for(var c=this.getParent(a);c;)c.classList.add("semiselected"),c=this.getParent(c)}};c.prototype._updateListBox=function(a,b){if(a){var c=this;if(!a.listbox){var d=
a.title_element.querySelector(".collapsebox"),f=LiteGUI.createLitebox(!0,function(b){c.onClickBox(b,a);LiteGUI.trigger(c.root,"item_collapse_change",{item:a,data:f.getValue()})});f.stopPropagation=!0;f.setEmpty(!0);d.appendChild(f);a.listbox=f}b&&b.collapsed&&a.listbox.collapse();(d=this.getChildren(a.dataset.item_id))&&(d.length?a.listbox.setEmpty(!1):a.listbox.setEmpty(!0))}};c.prototype.onClickBox=function(a,b){var c=this.getChildren(b);if(c)for(var d=0;d<c.length;++d){var f=c[d],g=this.getParent(f),
h=!0;g&&(h=this._isNodeChildrenVisible(g));h?f.classList.remove("hidden"):f.classList.add("hidden")}};LiteGUI.Tree=c})();
...
this.content=this.root.querySelector(".content");this.footer=this.root.querySelector(".panel-footer");!0==b.scroll&&(this.content.style.overflow="auto")};c.prototype.add=function(a){this.content.appendChild(a.root)};LiteGUI.Panel=c})();
...
{type:"number",step:0.1};break;case String:g[h]={type:"string"};break;case Boolean:g[h]={type:"boolean"};break;default:if(k&&k.length){var l=null!=k[0]&&k[0].constructor===Number;switch(k.length){case 2:g[h]={type:l?"vec2":"Array",step:0.1};break;case 3:g[h]={type:l?"vec3":"Array",step:0.1};break;case 4:g[h]={type:l?"vec4":"Array",step:0.1};break;default:g[h]={type:"Array"}}}}}if(e)for(h in e)delete g[e[h]];return this.showProperties(c,g)}};
Inspector.prototype.collectProperties=function(c){var a={},b;for(b in c)if("_"!=b[0]&&"@"!=b[0]&&"jQuery"!=b.substr(0,6)){var e=c[b];if(!e||e.constructor!=Function||c.constructor["@"+b])a[b]=e}return a};
Inspector.prototype.showProperties=function(c,a){for(var b in a){var e=b,d=a[b];if(d){d.constructor===String&&(d={type:d});d.name&&(e=d.name);if(!d.callback){var f={instance:c,name:e,options:d};d.callback=Inspector.assignValue.bind(f)}d.callback_update||(f={instance:c,name:e},d.callback_update=function(){return this.instance[this.name]}.bind(f));d.instance=c;d.varname=e;f=d.widget||d.type||"string";if(this.on_addProperty)this.on_addProperty(f,c,e,c[e],d);this.add(f,e,c[e],d)}}if(c.constructor.widgets)for(b in c.constructor.widgets)e=
...
f+" - 0px); '",f="style='width: calc( 100% - "+f+"); width: -webkit-calc(100% - "+f+"); width: -moz-calc( 100% - "+f+"); '");b.name_width&&(d="style='width: "+LiteGUI.sizeToCSS(b.name_width)+" '");b.content_width&&(f="style='width: "+LiteGUI.sizeToCSS(b.content_width)+" '");var g="",h="",k=this.one_line?"":"<span class='filling'></span>";b.pretitle&&(h=b.pretitle);var l="wcontent ",n=c;b.title&&(n=b.title);null===c||void 0===c?l+=" full":g=""===c?g+("<span class='wname' title='"+n+"' "+d+">"+h+"</span>"):
g+("<span class='wname' title='"+n+"' "+d+">"+h+c+k+"</span>");a.constructor===String||a.constructor===Number||a.constructor===Boolean?e.innerHTML=g+"<span class='info_content "+l+"' "+f+">"+a+"</span>":(e.innerHTML=g+"<span class='info_content "+l+"' "+f+"></span>",(c=e.querySelector("span.info_content"))&&c.appendChild(a));e.content=e.querySelector("span.info_content");e.remove=function(){this.parentNode&&this.parentNode.removeChild(this)};return e};
...
"",g.style.paddingLeft="")};b.icon&&f.setIcon(b.icon);f.setValue=function(a,b){void 0!==a&&a!==g.value&&(g.value=a,b||LiteGUI.trigger(g,"change"))};f.getValue=function(){return g.value};f.focus=function(){$(this).find("input").focus()};f.wchange=function(a){$(this).wchange(a)};this.append(f,b);this.processElement(f,b);return f};
...
a&&(this.value=a)});d.setIcon=function(a){a?(f.style.background="transparent url('"+a+"') no-repeat left 4px center",f.style.paddingLeft="1.7em"):(f.style.background="",f.style.paddingLeft="")};b.icon&&d.setIcon(b.icon);a=d.querySelector(".wcontent button");a.addEventListener("click",function(a){b.callback_button&&b.callback_button.call(d,f.value,a)});b.button_width&&(a.style.width=LiteGUI.sizeToCSS(b.button_width),d.querySelector(".inputfield").style.width="calc( 100% - "+a.style.width+" - 6px)");
this.tab_index+=1;this.append(d,b);d.wchange=function(a){$(this).wchange(a)};d.wclick=function(a){$(this).wclick(a)};d.setValue=function(a,b){f.value=a;b||LiteGUI.trigger(f,"change")};d.getValue=function(){return f.value};d.focus=function(){LiteGUI.focus(f)};this.processElement(d,b);return d};
...
f.addEventListener("keydown",b.callback_keydown);b.height&&(f.style.height="calc( "+LiteGUI.sizeToCSS(b.height)+" - 5px )");this.append(d,b);d.setValue=function(b,c){void 0!==b&&b!=f.value&&(a=b,f.value=b,c||LiteGUI.trigger(f,"change"))};d.getValue=function(a){return f.value};d.focus=function(){LiteGUI.focus(f)};this.processElement(d,b);return d};
...
b.precision&&(a=a.toFixed(b.precision)),a+=b.units||"",g.value!=a&&(g.value=a,c||LiteGUI.trigger(g,"change")))};d.setRange=function(a,b){f.setRange(a,b)};d.getValue=function(){return parseFloat(g.value)};d.focus=function(){LiteGUI.focus(g)};this.processElement(d,b);return d};
...
function(a){a=[];for(var e=0;e<l.length;e++)a.push(parseFloat(l[e].value));LiteGUI.trigger(f,"wbeforechange",[a]);d.values[c]=a;if(b.callback){var g=b.callback.call(f,a);if("object"==typeof g&&3<=g.length){for(e=0;e<l.length;e++)$(l[e]).val(g[e]);a=g}}LiteGUI.trigger(f,"wchange",[a]);if(d.onchange)d.onchange(c,a,f)});this.append(f,b);f.setValue=function(a,b){a&&(g.setValue(a[0],!0),h.setValue(a[1],!0),k.setValue(a[2],b))};f.setRange=function(a,b){g.setRange(a,b);h.setRange(a,b);k.setRange(a,b)};this.processElement(f,
b);return f};
...
Inspector.prototype.addPad=function(c,a,b){b=this.processOptions(b);b.step||(b.step=0.1);a=a||[0,0];var e=this;this.values[c]=a;var d=this.createWidget(c,"",b);b.step=b.step||0.1;b.tab_index=this.tab_index;b.full=!0;this.tab_index++;var f=b.minx||b.min||0,g=b.miny||b.min||0,h=b.maxx||b.max||1,k=b.maxy||b.max||1,l=d.querySelector(".wcontent"),n=document.createElement("div");n.className="litepad";l.appendChild(n);n.style.width="100%";n.style.height="100px";b.background&&(n.style.backgroundImage="url('"+
b.background+"')",n.style.backgroundSize="100%",n.style.backgroundRepeat="no-repeat");var p=document.createElement("div");p.className="litepad-handler";n.appendChild(p);b.tab_index=this.tab_index;this.tab_index++;n._onMouseEvent=function(a){var l=n.getBoundingClientRect();a.mousex=a.pageX-l.left;a.mousey=a.pageY-l.top;a.preventDefault();a.stopPropagation();if("mousedown"==a.type)document.body.addEventListener("mousemove",n._onMouseEvent),document.body.addEventListener("mouseup",n._onMouseEvent);else if("mousemove"==
a.type){var p=a.mousex/l.width;a=a.mousey/l.height;p=p*(h-f)+f;a=a*(k-g)+f;p=[p,a];LiteGUI.trigger(d,"wbeforechange",[p]);d.setValue(p);if(b.callback&&(a=b.callback.call(d,p))&&2<=a.length)for(l=0;l<elems.length;l++)d.setValue(a);LiteGUI.trigger(d,"wchange",[p]);if(e.onchange)e.onchange(c,p,d)}else"mouseup"==a.type&&(document.body.removeEventListener("mousemove",n._onMouseEvent),document.body.removeEventListener("mouseup",n._onMouseEvent));return!0};n.addEventListener("mousedown",n._onMouseEvent);
...
Inspector.prototype.addInfo=function(c,a,b){b=this.processOptions(b);a=void 0===a||null===a?"":a;var e=null;null!=c?e=this.createWidget(c,a,b):(e=document.createElement("div"),b.className&&(e.className=b.className),void 0!==a.nodeName?(e.innerHTML="<span class='winfo'></span>",e.childNodes[0].appendChild(a)):e.innerHTML="<span class='winfo'>"+a+"</span>");var d=e.querySelector(".winfo")||e.querySelector(".wcontent");e.setValue=function(a){void 0!==a&&d&&(d.innerHTML=a)};var f=e.querySelector("span.info_content");
f||(f=e.querySelector(".winfo"));b.height&&(f.style.height=LiteGUI.sizeToCSS(b.height),f.style.overflow="auto");e.scrollToBottom=function(){f.scrollTop=f.offsetTop};e.add=function(a){f.appendChild(a)};this.append(e,b);this.processElement(e,b);return e};
...
function(){var a=!this.data;this.data=a;g.querySelector("span.flag").innerHTML=a?d:f;a?h.classList.add("on"):h.classList.remove("on");Inspector.onWidgetChange.call(e,g,c,a,b)});g.data=a;g.setValue=function(a,b){void 0!==a&&(e.values[c]==a||b||LiteGUI.trigger(h,"click"))};this.append(g,b);this.processElement(g,b);return g};
...
Inspector.prototype.addCombo=function(c,a,b){function e(b,c){b||(b=[]);g=b;c&&(a=c);var d="",e=0,h;for(h in g){var k=g[h],s=g.constructor===Array?e:h,u=g.constructor===Array?k:h;k&&k.title&&(u=k.title);d+="<option value='"+s+"' "+(k==a?" selected":"")+" data-index='"+s+"'>"+u+"</option>";e++}f.querySelector("select").innerHTML=d}b=this.processOptions(b);var d=this;this.values[c]=a;this.tab_index++;var f=this.createWidget(c,"<span class='inputfield full inputcombo "+(b.disabled?"disabled":"")+"'></span>",
b);f.options=b;var g=b.values||[];g.constructor===Function&&(g=b.values());var h="<select tabIndex='"+this.tab_index+"' "+(b.disabled?"disabled":"")+" class='"+(b.disabled?"disabled":"")+"'></select>";f.querySelector("span.inputcombo").innerHTML=h;e(g);var k=!1;f.querySelector(".wcontent select").addEventListener("change",function(a){a=g[a.target.value];k||Inspector.onWidgetChange.call(d,f,c,a,b)});f.setValue=function(b,c){if(void 0!==b){a=b;var d=f.querySelector("select"),e=d.querySelectorAll("option"),
h=-1;if(g.constructor===Array)h=g.indexOf(b);else{var r=0,s;for(s in g)if(g[r]==b){h=r;break}else r++}if(-1!=h){k=c;for(s in e)(r=e[s])&&r.dataset&&(parseFloat(r.dataset.index)==h?(r.setAttribute("selected",!0),d.selectedIndex=h):r.removeAttribute("selected"));k=!1}}};f.setOptionValues=e;this.append(f,b);this.processElement(f,b);return f};
Inspector.prototype.addComboButtons=function(c,a,b){b=this.processOptions(b);a=a||"";var e=this;this.values[c]=a;var d="";if(b.values)for(var f in b.values)d+="<button class='wcombobutton "+(a==b.values[f]?"selected":"")+"' data-name='options.values[i]'>"+b.values[f]+"</button>";var g=this.createWidget(c,d,b);a=g.querySelectorAll(".wcontent button");LiteGUI.bind(a,"click",function(a){a=a.target.innerHTML;e.values[c]=a;var d=g.querySelectorAll(".selected"),f;for(f in d)d.classList.remove("selected");
...
Inspector.prototype.addList=function(c,a,b){function e(a){var b=k.querySelector("li.selected");if(b){if(40==a.keyCode)(b=b.nextSibling)&&LiteGUI.trigger(b,"click");else if(38==a.keyCode)(b=b.previousSibling)&&LiteGUI.trigger(b,"click");else return;a.preventDefault();a.stopPropagation();return!0}}function d(d){if(b.multiselection)this.classList.toggle("selected");else{d=k.querySelectorAll("li");for(var e=0;e<d.length;++e)d[e].classList.remove("selected");this.classList.add("selected")}d=a[this.dataset.pos];
...
"100%";h=k.querySelector(".inputfield");h.style.height="100%";h.style.paddingBottom="0.2em";for(var h=k.querySelectorAll("ul"),l=0;l<h.length;++l){var n=h[l];n.addEventListener("focus",function(){document.addEventListener("keydown",e,!0)});n.addEventListener("blur",function(){document.removeEventListener("keydown",e,!0)})}k.updateItems=function(c,e){e=e||b.selected;a=c;var g=this.querySelector("ul");g.innerHTML="";if(a)for(var h in a){var k=a[h],l=a.constructor===Array?k:h;l||(l=h);var n=l.constructor===
String?l:h,y=null;l&&l.constructor===String&&(l=l.replace(/<(?:.|\n)*?>/gm,""));var z="";null!==k&&void 0!==k&&k.constructor!==String&&k.constructor!==Number&&k.constructor!==Boolean&&k&&(n=k.content||k.name||h,y=k.style,k.icon&&(z="<img src='"+k.icon+"' class='icon' />"));k=!1;if("object"==typeof a[h]&&a[h].selected||e==a[h])k=!0;var t=document.createElement("li");t.classList.add("item-"+LiteGUI.safeName(h));k&&t.classList.add("selected");t.dataset.name=l;t.dataset.pos=h;t.value=a[h];y&&t.setAttribute("style",
y);t.innerHTML=z+n;g.appendChild(t);t.addEventListener("click",d);b.callback_dblclick&&t.addEventListener("dblclick",f)}LiteGUI.bind(g.querySelectorAll("li"),"click",d)};k.removeItem=function(a){for(var b=k.querySelectorAll(".wcontent li"),c=0;c<b.length;c++)b[c].dataset.name==a&&LiteGUI.remove(b[c])};k.updateItems(a,b.selected);this.append(k,b);k.getSelected=function(){for(var a=[],b=this.querySelectorAll("ul li.selected"),c=0;c<b.length;++c)a.push(b[c].dataset.name);return a};k.getByIndex=function(a){return this.querySelectorAll("ul li")[a]};
...
"wclick",a)});this.append(g,b);g.wclick=function(a){b.disabled||LiteGUI.bind(this,"wclick",a)};g.setValue=function(a){void 0!==a&&(h.innerHTML=a)};this.processElement(g,b);return g};
Inspector.prototype.addButtons=function(c,a,b){b=this.processOptions(b);a=a||"";var e=this,d="",f="calc( "+(100/a.length).toFixed(3)+"% - 4px )",f="width:"+f+"; width: -moz-"+f+"; width: -webkit-"+f+"; margin: 2px;";if(a&&"object"==typeof a)for(var g in a)d+="<button class='litebutton' tabIndex='"+this.tab_index+"' style='"+f+"'>"+a[g]+"</button>",this.tab_index++;var h=this.createWidget(c,d,b);a=h.querySelectorAll("button");for(g=0;g<a.length;++g)a[g].addEventListener("click",function(a){Inspector.onWidgetChange.call(e,
...
"0";l.style.display="inline-block";l.style.cursor="pointer";l.style.width=f+"px";l.style.height=g+"px";l.style.backgroundImage="url('"+d+"')";l.style.backgroundPosition=n+"px "+(a?g:0)+"px";l.addEventListener("mousedown",function(d){d.preventDefault();a=!a;d=Inspector.onWidgetChange.call(e,h,c,a,b);LiteGUI.trigger(h,"wclick",a);void 0!==d&&(a=d);l.style.backgroundPosition=n+"px "+(a?g:0)+"px";!1===b.toggle&&setTimeout(function(){l.style.backgroundPosition=n+"px 0px";a=!1},200)});this.append(h,b);
h.setValue=function(d,f){void 0!==d&&(a=d,l.style.backgroundPosition=n+"px "+(a?g:0)+"px",f||Inspector.onWidgetChange.call(e,h,c,a,b))};h.getValue=function(){return a};this.processElement(h,b);return h};
...
d);e.values[c]=a;b.callback&&b.callback.call(f,a.concat(),"#"+g.toString(),g);LiteGUI.trigger(f,"wchange",d);if(e.onchange)e.onchange(c,a.concat(),f)};b.step=b.step||0.01;b.dragger_class="nano";var h=new LiteGUI.Dragger(1,b);f.querySelector(".wcontent").appendChild(h.root);h.input.addEventListener("change",function(a){a=parseFloat(this.value);g.rgb_intensity=a;if(g.onImmediateChange)g.onImmediateChange()});f.setValue=function(a,b){g.fromRGB(a[0],a[1],a[2]);b||LiteGUI.trigger(h.input,"change")}}else d.addEventListener("change",
...
Inspector.prototype.addFile=function(c,a,b){b=this.processOptions(b);a=a||"";var e=this;this.values[c]=a;var d=this.createWidget(c,"<span class='inputfield full whidden' style='width: calc(100% - 26px)'><span class='filename'>"+a+"</span></span><button class='litebutton' style='width:20px; margin-left: 2px;'>...</button><input type='file' size='100' class='file' value='"+a+"'/>",b);d.querySelector(".wcontent").style.position="relative";a=d.querySelector(".wcontent input");var f=d.querySelector(".wcontent .filename");
a.addEventListener("change",function(a){if(a.target.files.length){var h=null;b.generate_url&&(h=URL.createObjectURL(a.target.files[0]));var k={url:h,filename:a.target.value,file:a.target.files[0],files:a.target.files};b.read_file?(a=new FileReader,a.onload=function(a){k.data=a.target.result;Inspector.onWidgetChange.call(e,d,c,k,b)},"binary"==b.read_file?a.readAsArrayBuffer(k.file):"data_url"==b.read_file?a.readAsDataURL(k.file):a.readAsText(k.file)):(f.innerHTML=a.target.files[0].name,Inspector.onWidgetChange.call(e,
d,c,k,b))}else f.innerHTML="",Inspector.onWidgetChange.call(e,d,c,null,b)});this.append(d,b);return d};
Inspector.prototype.addLine=function(c,a,b){b=this.processOptions(b);a=a||"";var e=this;this.values[c]=a;var d=this.createWidget(c,"<span class='line-editor'></span>",b);a=new LiteGUI.LineEditor(a,b);d.querySelector("span.line-editor").appendChild(a);LiteGUI.bind(a,"change",function(a){LiteGUI.trigger(d,"wbeforechange",[a.target.value]);b.callback&&b.callback.call(d,a.target.value);LiteGUI.trigger(d,"wchange",[a.target.value]);Inspector.onWidgetChange.call(e,d,c,a.target.value,b)});this.append(d,
b);return d};
...
Inspector.prototype.addArray=function(c,a,b){function e(){var a=this,c=a.value,k=Math.min(c.length,h);f.widgets_per_row=2;a.innerHTML="";for(var q=0;q<k;++q){var r=null;void 0!==c[q]&&(r=c[q]);var s={widget_parent:a,name_width:30,width:"100% - 40px",callback:d.bind({value:this.value,index:q})};if(b.data_options)for(var u in b.data_options)s[u]=b.data_options[u];f.add(g,q,r,s);f.addButton(null,"<img src='imgs/mini-icon-trash.png'/>",{widget_parent:a,index:q,width:30,callback:function(){c&&c.length>
this.options.index-1&&(c.splice(this.options.index,1),l.setValue(c.length,!0),e.call(a))}})}f.widgets_per_row=1}function d(a){this.value[this.index]=a;b.callback&&b.callback.call(k,this.value,this.index)}var f=this;if(a&&a.constructor===Array){b=this.processOptions(b);var g=b.data_type||"string",h=b.max_items||100,k=null;this.widgets_per_row=3;this.addInfo(c,null,{name_width:"100%",width:"100% - 160px"});var l=this.addString("length",a.length||"0",{width:100,callback:function(b){b=parseInt(b);0>a&&
(a=0);a.length=b;e.call(k)}});this.addButtons(null,["+","-"],{width:60,callback:function(b){"+"==b?a.length+=1:0<a.length&&(a.length-=1);l.setValue(a.length);e.call(k)}});this.widgets_per_row=1;k=this.addContainer(c,b);k.value=a;e.call(k);k.setValue=function(a){this.value=a;e.call(k)};k.getValue=function(){return this.value=v};return k}console.error("Inspector: Array widget value must be a valid array")};
Inspector.prototype.addContainer=function(c,a){var b=this.startContainer(null,a);this.endContainer();return b};
...
Inspector.prototype.beginGroup=function(c,a){a=this.processOptions(a);var b=document.createElement("DIV");b.className="wgroup";b.innerHTML="<div class='wgroupheader "+(a.title?"wtitle":"")+"'><span class='switch-section-button'></span>"+(c||"")+"</div>";b.group=!0;var e=document.createElement("DIV");e.className="wgroupcontent";a.collapsed&&(e.style.display="none");b.appendChild(e);var d=a.collapsed||!1,f=b.querySelector(".wgroupheader");d&&f.classList.add("collapsed");f.addEventListener("click",function(a){var c=
b.querySelector(".wgroupcontent").style;c.display="none"===c.display?"":"none";(d=!d)?f.classList.add("collapsed"):f.classList.remove("collapsed");a.preventDefault()});this.append(b,a);this.pushContainer(e);return b};Inspector.prototype.endGroup=function(){do this.popContainer();while(this._current_container&&!this._current_container.classList.contains("wgroupcontent"))};
