...
var ThreeJSEngine = {
	...
	init: function()
	{
		LiteGUI.requireScript(["http://threejs.org/build/three.min.js"], inner );

		function inner(v)
		{
			console.log("ThreeJS engine loaded");
		}
	},
...
function ThreeJS( o )
{
	...
	{
		console.error("THREEJS library not found");
		return;
	}
...
{
	ThreeJS.onShowProperties = function( component, inspector )
	{
	...
	CORE.registerModule( ThreeJSEngine );
}
