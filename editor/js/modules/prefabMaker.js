var PrefabMaker = {
	...
	init: function()
	{
		...
		LiteGUI.menubar.add("Actions/Create Pack", { callback: function() { PrefabMaker.showCreatePackDialog(); }} );
	},
	...
	showCreatePackDialog: function( options )
	{
		...
		function inner_update()
		{
			...
			widgets.addButton(null,"Create Pack", function(){
				PrefabMaker.createPack( filename, resources );
				dialog.close();
