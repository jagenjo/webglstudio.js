...
function coordsCharInner(cm, lineObj, lineNo$$1, x, y) {
  ...
  if (order) {
    ...
    outer: do {
      ...
      var bidiPart = order[getBidiPartAt(order, pos.ch, dir < 0 ? "before" : "after")];
      var maxSteps = Math.max(1, Math.min(steps, (dir < 0) != (bidiPart.level % 2 > 0) ? pos.ch - bidiPart.from : bidiPart.to - pos.ch));
      ...
      if (steps > 1) {
        var diffChangePerStep = Math.abs(diff - prevDiff) / steps;
