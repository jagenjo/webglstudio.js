var LiteGUI={root:null,content:null,panels:{},windows:[],undo_steps:[],modalbg_div:null,mainmenu:null,init:function(c){c=c||{};c.width&&c.height&&this.setWindowSize(c.width,c.height);this.container=null;c.container&&(this.container=document.getElementById(c.container));this.container||(this.container=document.body);if(c.wrapped){var a=document.createElement("div");a.className="litegui-wrap fullscreen";a.style.position="relative";a.style.overflow="hidden";this.root=a;this.container.appendChild(a);
a=document.createElement("div");a.className="litegui-maincontent";this.content=a;this.root.appendChild(a);this.root.classList.contains("fullscreen")&&window.addEventListener("resize",function(a){LiteGUI.maximizeWindow()})}else this.root=this.container;a=this.modalbg_div=document.createElement("div");this.modalbg_div.className="litemodalbg";this.root.appendChild(this.modalbg_div);a.style.display="none";c.menubar&&this.createMenubar();c.gui_callback&&c.gui_callback();window.addEventListener("beforeunload",
...
a.type){var r=a.mousex/l.width;a=a.mousey/l.height;r=r*(h-f)+f;a=a*(k-g)+f;r=[r,a];LiteGUI.trigger(d,"wbeforechange",[r]);d.setValue(r);if(b.callback&&(a=b.callback.call(d,r))&&2<=a.length)for(l=0;l<elems.length;l++)d.setValue(a);LiteGUI.trigger(d,"wchange",[r]);if(e.onchange)e.onchange(c,r,d)}else"mouseup"==a.type&&(document.body.removeEventListener("mousemove",n._onMouseEvent),document.body.removeEventListener("mouseup",n._onMouseEvent));return!0};n.addEventListener("mousedown",n._onMouseEvent);
...
String||a.constructor===Number||a.constructor===Boolean?g=String(a):a&&(g=a.content||a.title||a.name||e,h=a.style,a.icon&&(k="<img src='"+a.icon+"' class='icon' /> "),a.selected&&(c=!0)));var l;l=g.replace(/<(?:.|\n)*?>/gm,"");var n=document.createElement("li");n.classList.add("item-"+LiteGUI.safeName(e));c&&n.classList.add("selected");n.dataset.name=l;n.dataset.pos=e;n.value=a;h&&n.setAttribute("style",h);n.innerHTML=k+g;n.addEventListener("click",d);b.callback_dblclick&&n.addEventListener("dblclick",
...
Inspector.prototype.addArray=function(c,a,b){function e(){var a=this.value,c=Math.min(a.length,h);f.widgets_per_row+=1;this.innerHTML="";for(var e=0;e<c;++e){var l=null;void 0!==a[e]&&(l=a[e]);var k=document.createElement("div");k.className="array-row";k.innerHTML="<span class='row-index'>"+e+"</span><span class='row-cell'></span><button style='width: 30px;' class='litebutton single row-trash'><img src='imgs/mini-icon-trash.png'/></button>";this.appendChild(k);k={widget_parent:k.querySelector(".row-cell"),
callback:d.bind({value:this.value,index:e})};if(b.data_options)for(var s in b.data_options)k[s]=b.data_options[s];f.add(g,null,l,k)}f.widgets_per_row-=1}function d(a){this.value[this.index]=a;b.callback&&b.callback.call(k,this.value,this.index)}var f=this;if(a&&a.constructor===Array){b=this.processOptions(b);var g=b.data_type||"string",h=b.max_items||100,k=null;this.widgets_per_row=3;this.addInfo(c,null,{name_width:"100%",width:"100% - 160px"});var l=this.addString("length",a.length||"0",{width:100,
