...
refresh:"&#8634;",gear:"&#9881;",open_folder:"&#128194;"},htmlEncode:function(c){var a=document.createElement("div");a.innerHTML=c;return a.innerText},htmlDecode:function(c){var a=document.createElement("div");a.innerText=c;return a.innerHTML},sizeToCSS:function(c){return void 0===c||null===c?null:c.constructor===String?c:0<=c?(c|0)+"px":"calc( 100% - "+Math.abs(c|0)+"px )"},createDropArea:function(c,a,b,e){function d(a){c.addEventListener("dragexit",d);c.addEventListener("dragover",d);c.addEventListener("drop",
...
"litecontextmenu litemenubar-panel";h.style.minWidth=100;h.style.minHeight=100;h.style.pointerEvents="none";setTimeout(function(){h.style.pointerEvents="auto"},100);h.addEventListener("mouseup",function(a){a.preventDefault();return!0},!0);h.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);h.addEventListener("mousedown",function(a){if(2==a.button)return g.close(),a.preventDefault(),!0},!0);this.root=h;if(b.title){var k=document.createElement("div");
k.className="litemenu-title";k.innerHTML=b.title;h.appendChild(k)}var k=0,l;for(l in a){var n=a.constructor==Array?a[l]:l;null!=n&&n.constructor!==String&&(n=void 0===n.content?String(n):n.content);this.addItem(n,a[l],b);k++}h.addEventListener("mouseleave",function(a){g.lock||(h.closing_timer&&clearTimeout(h.closing_timer),h.closing_timer=setTimeout(g.close.bind(g,a),500))});h.addEventListener("mouseenter",function(a){h.closing_timer&&clearTimeout(h.closing_timer)});h.addEventListener("wheel",c,!0);
h.addEventListener("mousewheel",c,!0);l=document;b.event&&(l=b.event.target.ownerDocument);l||(l=document);l.body.appendChild(h);k=b.left||0;l=b.top||0;if(b.event)if("MouseEvent"!==b.event.constructor.name&&"CustomEvent"!==b.event.constructor.name)console.warn("Event passed to ContextMenu is not of type MouseEvent"),b.event=null;else{k=b.event.pageX-10;l=b.event.pageY-10;b.title&&(l-=20);b.parentMenu&&(k=b.parentMenu.root.getBoundingClientRect(),k=k.left+k.width);var n=document.body.getBoundingClientRect(),
p=h.getBoundingClientRect();k>n.width-p.width-10&&(k=n.width-p.width-10);l>n.height-p.height-10&&(l=n.height-p.height-10)}h.style.left=k+"px";h.style.top=l+"px"}function b(a,b,c){c=c||{};var g=this.root=document.createElement("ul");g.id=a;g.className="litelist";this.items=[];var h=this;this.callback=c.callback;for(var k in b){a=document.createElement("li");a.className="list-item";a.data=b[k];a.dataset.value=b[k];var l="";"string"==typeof b[k]?l=b[k]+"<span class='arrow'></span>":(l=(b[k].name||b[k].title||
"")+"<span class='arrow'></span>",b[k].id&&(a.id=b[k].id));a.innerHTML=l;a.addEventListener("click",function(){for(var a=g.querySelectorAll(".list-item.selected"),b=0;b<a.length;++b)a[b].classList.remove("selected");this.classList.add("selected");LiteGUI.trigger(h.root,"wchanged",this);h.callback&&h.callback(this.data)});g.appendChild(a)}c.parent&&(c.parent.root?c.parent.root.appendChild(g):c.parent.appendChild(g))}LiteGUI.Button=function(a,b){b=b||{};"function"===typeof b&&(b={callback:b});var c=
...
function(a){for(var b=this.root.querySelectorAll(".list-item"),c=0;c<b.length;c++){var g=b[c];if(g.data==a){LiteGUI.trigger(g,"click");break}}};LiteGUI.List=b;LiteGUI.Slider=function(a,b){function c(a){var e=k.getBoundingClientRect();if(e){var f=b.min||0;l.setValue(a/e.width*((b.max||1)-f)+f)}}function g(a){var b=k.getBoundingClientRect();if(b)return c((void 0===a.x?a.pageX:a.x)-b.left),a.preventDefault(),!1}function h(a){var b=n||document;n=null;b.removeEventListener("mousemove",g);b.removeEventListener("mouseup",
h);a.preventDefault();return!1}b=b||{};var k=this.root=document.createElement("div"),l=this;this.value=a;k.className="liteslider";this.setValue=function(a,c){var e=b.min||0,f=b.max||1;a<e?a=e:a>f&&(a=f);f=(a-e)/(f-e);e=(100*f).toFixed(1)+"%";f=(100*f+2).toFixed(1)+"%";k.style.background="linear-gradient(to right, #999 "+e+", #FC0 "+f+", #333 "+f+")";if(a!=this.value&&(this.value=a,!c&&(LiteGUI.trigger(this.root,"change",a),this.onChange)))this.onChange(a)};var n=null;k.addEventListener("mousedown",
function(a){var b;a.offsetX?b=a.offsetX:a.layerX&&(b=a.layerX);c(b);n=k.ownerDocument;n.addEventListener("mousemove",g);n.addEventListener("mouseup",h);a.preventDefault();a.stopPropagation()});this.setValue(a)};LiteGUI.LineEditor=function(a,b){function c(a){return[q.width*((m.xrange[1]-m.xrange[0])*a[0]+m.xrange[0]),q.height*((m.yrange[1]-m.yrange[0])*a[1]+m.yrange[0])]}function g(a){return[(a[0]/q.width-m.xrange[0])/(m.xrange[1]-m.xrange[0]),(a[1]/q.height-m.yrange[0])/(m.yrange[1]-m.yrange[0])]}
...
m.yrange[1]&&(h[1]=m.yrange[1])}p();m.redraw();s[0]=c;s[1]=e;l();a.preventDefault();a.stopPropagation()}}function k(a){r=-1;m.redraw();document.removeEventListener("mousemove",h);document.removeEventListener("mouseup",k);l();a.preventDefault();a.stopPropagation()}function l(){b.callback?b.callback.call(m,m.value):LiteGUI.trigger(m,"change")}function n(a,b){return Math.sqrt(Math.pow(b[0]-a[0],2)+Math.pow(b[1]-a[1],2))}function p(){var a=null;-1!=r&&(a=m.value[r]);m.value.sort(function(a,b){return a[0]-
...
"20px";var q=document.createElement("canvas");q.width=b.width||200;q.height=b.height||50;m.appendChild(q);m.canvas=q;m.addEventListener("mousedown",function(a){document.addEventListener("mousemove",h);document.addEventListener("mouseup",k);for(var b=q.getBoundingClientRect(),e=a.clientX-b.left,b=a.clientY-b.top,d=q.height-b,l=1E5,A=-1,w=0;w<m.value.length;w++){var u=c(m.value[w]),u=n([e,d],u);u<l&&8>u&&(l=u,A=w)}r=A;-1==r&&(d=g([e,q.height-b]),m.value.push(d),p(),r=m.value.indexOf(d));s=[e,b];m.redraw();
...
(function(){function c(a){a=a||{};this.root=document.createElement("div");this.root.className="liteconsole";this.root.innerHTML="<div class='log'></div><div class='foot'><input type='text'/></div>";this.log_element=this.root.querySelector(".log");this.input=this.root.querySelector("input");this.input.addEventListener("keydown",this.onKeyDown.bind(this));this._prompt=a.prompt||"]";this.history=[];this._history_offset=0}c.prototype.onKeyDown=function(a){if(!this._input_blocked){if(13==a.keyCode){var b=
this.input.value.trim();this.addMessage(this._prompt+b,"me",!0);this.input.value="";this.history.push(b);10<this.history.length&&this.history.shift();if(this.onProcessCommand)this.onProcessCommand(b);this._history_offset=0}else if(38==a.keyCode||40==a.keyCode){this._history_offset+=38==a.keyCode?-1:1;0<this._history_offset?this._history_offset=0:this._history_offset<-this.history.length&&(this._history_offset=-this.history.length);b=this.history.length+this._history_offset;if(0>b)return;this.input.value=
b>=this.history.length?"":this.history[b]}else if(9==a.keyCode)if(this.onAutocomplete)this.input.value=this.onAutocomplete(this.input.value);else return;else return;a.preventDefault();a.stopPropagation()}};c.prototype.addMessage=function(a,b,c){function d(a,d){g=document.createElement("pre");c?g.innerText=a:g.innerHTML=a;g.className="msg";b&&(g.className+=" "+b);f.appendChild(g);1E3<f.children.length&&f.removeChild(f.children[0])}var f=this.log_element,g=null;if(a&&a.constructor===Array)for(var h=
0;h<a.length;++h)d(a[h]);else a&&a.constructor===Object?d(JSON.stringify(a,null,""),this):d(a,this);this.log_element.scrollTop=1E6;g.update=function(a){this.innerHTML=a};return g};c.prototype.log=function(){var a=Array.prototype.slice.call(arguments).join(",");return this.addMessage(a,"msglog")};c.prototype.warn=function(){var a=Array.prototype.slice.call(arguments).join(",");return this.addMessage(a,"msgwarn")};c.prototype.error=function(){var a=Array.prototype.slice.call(arguments).join(",");return this.addMessage(a,
"msgerror")};c.prototype.clear=function(){this.log_element.innerHTML=""};LiteGUI.Console=c})();
...
" ltreeitem-"+k;b.dataset.item_id=a.id}if(a.dataset)for(var l in a.dataset)b.dataset[l]=a.dataset[l];a.DOM=b;b.data=a;void 0!==c&&(b.dataset.level=c,b.classList.add("ltree-level-"+c));var n=document.createElement("div");n.className="ltreeitemtitle";a.className&&(n.className+=" "+a.className);n.innerHTML="<span class='precontent'></span><span class='indentblock'></span><span class='collapsebox'></span><span class='incontent'></span><span class='postcontent'></span>";c=a.content||a.id||"";n.querySelector(".incontent").innerHTML=
c;a.precontent&&(n.querySelector(".precontent").innerHTML=a.precontent);if(a.dataset)for(l in a.dataset)b.dataset[l]=a.dataset[l];b.appendChild(n);b.title_element=n;!1===a.visible&&(b.style.display="none");b.addEventListener("click",d);b.addEventListener("dblclick",f);b.addEventListener("contextmenu",function(a){a.preventDefault();a.stopPropagation();if(2==a.button)return h.onItemContextMenu?h.onItemContextMenu(a,{item:this,data:this.data}):!1});this.options.allow_drag&&(n.draggable=!0,n.addEventListener("dragstart",
function(b){b.dataTransfer.setData("item_id",this.parentNode.dataset.item_id);if(a.onDragData){var c=a.onDragData();if(c)for(var e in c)b.dataTransfer.setData(e,c[e])}}));var p=0;n.addEventListener("dragenter",function(b){b.preventDefault();if(a.skipdrag)return!1;0==p&&n.classList.add("dragover");p++});n.addEventListener("dragleave",function(a){a.preventDefault();p--;0==p&&n.classList.remove("dragover")});n.addEventListener("dragover",g);n.addEventListener("drop",function(b){n.classList.remove("dragover");
b.preventDefault();if(a.skipdrag)return!1;var c=b.dataTransfer.getData("item_id");if(c){var e=this.parentNode.dataset.item_id;(!h.onMoveItem||h.onMoveItem&&!1!=h.onMoveItem(h.getItem(c),h.getItem(e)))&&h.moveItem(c,e)&&LiteGUI.trigger(h.root,"item_moved",{item:h.getItem(c),parent_item:h.getItem(e)})}else LiteGUI.trigger(h.root,"drop_on_item",{item:this,event:b});if(h.onDropItem)h.onDropItem(b,this.parentNode.data)});return b}};c.prototype.filterByName=function(a){for(var b=0;b<this.root.childNodes.length;++b){var e=
this.root.childNodes[b];if(e.classList&&e.classList.contains("ltreeitem")){var d=e.querySelector(".incontent");if(d)if(d=d.innerHTML.toLowerCase(),a&&-1==d.indexOf(a.toLowerCase()))e.classList.add("filtered");else if(e.data&&!1!==e.data.visible&&e.classList.remove("filtered"),d=e.querySelector(".indentblock"))d.style.paddingLeft=a?0:paddingLeft=(parseInt(e.dataset.level)+this.indent_offset)*c.INDENT+"px"}}};c.prototype.filterByRule=function(a,b){if(!a)throw"filterByRule requires a callback";for(var c=
0;c<this.root.childNodes.length;++c){var d=this.root.childNodes[c];if(d.classList&&d.classList.contains("ltreeitem")){var f=d.querySelector(".incontent");if(f)if(a(d.data,f,b)){if(d.data&&!1!==d.data.visible&&d.classList.remove("filtered"),f=d.querySelector(".indentblock"))f.style.paddingLeft=name?0:paddingLeft=(parseInt(d.dataset.level)+this.indent_offset)*LiteGUI.Tree.INDENT+"px"}else d.classList.add("filtered")}}};c.prototype.getItem=function(a){if(!a)return null;if(a.classList)return a;for(var b=
...
{type:"number",step:0.1};break;case String:g[h]={type:"string"};break;case Boolean:g[h]={type:"boolean"};break;default:if(k&&k.length){var l=null!=k[0]&&k[0].constructor===Number;switch(k.length){case 2:g[h]={type:l?"vec2":"Array",step:0.1};break;case 3:g[h]={type:l?"vec3":"Array",step:0.1};break;case 4:g[h]={type:l?"vec4":"Array",step:0.1};break;default:g[h]={type:"Array"}}}}}if(e)for(h in e)delete g[e[h]];if(f.properties_order){a={};for(h in f.properties_order)b=f.properties_order[h],g[b]?a[b]=
...
a&&d&&(d.innerHTML=a)};var f=e.querySelector("span.info_content");f||(f=e.querySelector(".winfo"));b.height&&(f.style.height=LiteGUI.sizeToCSS(b.height),f.style.overflow="auto");e.scrollToBottom=function(){f.scrollTop=f.offsetTop};e.add=function(a){f.appendChild(a)};this.append(e,b);this.processElement(e,b);return e};
...
Inspector.prototype.addList=function(c,a,b){function e(c){var d=k.querySelector("li.selected");if(d){if(13==c.keyCode){if(!d)return;d=a[d.dataset.pos];b.callback_dblclick&&b.callback_dblclick.call(g,d)}else if(40==c.keyCode){var e=d.nextSibling;e&&LiteGUI.trigger(e,"click");d.scrollIntoViewIfNeeded&&d.scrollIntoViewIfNeeded({block:"end",behavior:"smooth"})}else if(38==c.keyCode)(e=d.previousSibling)&&LiteGUI.trigger(e,"click"),d.scrollIntoViewIfNeeded&&d.scrollIntoViewIfNeeded({block:"end",behavior:"smooth"});
else return;c.preventDefault();c.stopPropagation();return!0}}function d(d){if(b.multiselection)this.classList.toggle("selected");else{d=k.querySelectorAll("li");for(var e=0;e<d.length;++e)d[e].classList.remove("selected");this.classList.add("selected")}d=a[this.dataset.pos];Inspector.onWidgetChange.call(g,k,c,d,b);LiteGUI.trigger(k,"wadded",d)}function f(c){c=a[this.dataset.pos];b.callback_dblclick&&b.callback_dblclick.call(g,c)}b=this.processOptions(b);var g=this,h="";b.height&&(h="style='height: 100%; overflow: auto;'");
h="<ul class='lite-list' "+h+" tabIndex='"+this.tab_index+"'><ul>";this.tab_index++;var k=this.createWidget(c,"<span class='inputfield full "+(b.disabled?"disabled":"")+"' style='height: 100%;'>"+h+"</span>",b);k.querySelector(".info_content").style.height="100%";k.querySelector(".lite-list");h=k.querySelector(".inputfield");h.style.height="100%";h.style.paddingBottom="0.2em";for(var h=k.querySelectorAll("ul"),l=0;l<h.length;++l){var n=h[l];n.addEventListener("focus",function(){document.addEventListener("keydown",
e,!0)});n.addEventListener("blur",function(){document.removeEventListener("keydown",e,!0)})}k.updateItems=function(c,e){e=e||b.selected;a=c;var g=this.querySelector("ul");g.innerHTML="";if(a)for(var h in a){var k=a[h],l=a.constructor===Array?k:h;l||(l=h);var n=l.constructor===String?l:h,x=null;l&&l.constructor===String&&(l=l.replace(/<(?:.|\n)*?>/gm,""));var z="";null!==k&&void 0!==k&&k.constructor!==String&&k.constructor!==Number&&k.constructor!==Boolean&&k&&(n=k.content||k.name||h,x=k.style,k.icon&&
(z="<img src='"+k.icon+"' class='icon' />"));k=!1;if("object"==typeof a[h]&&a[h].selected||e==a[h])k=!0;var t=document.createElement("li");t.classList.add("item-"+LiteGUI.safeName(h));k&&t.classList.add("selected");t.dataset.name=l;t.dataset.pos=h;t.value=a[h];x&&t.setAttribute("style",x);t.innerHTML=z+n;g.appendChild(t);t.addEventListener("click",d);b.callback_dblclick&&t.addEventListener("dblclick",f)}LiteGUI.bind(g.querySelectorAll("li"),"click",d)};k.removeItem=function(a){for(var b=k.querySelectorAll(".wcontent li"),
c=0;c<b.length;c++)b[c].dataset.name==a&&LiteGUI.remove(b[c])};k.updateItems(a,b.selected);this.append(k,b);k.getSelected=function(){for(var a=[],b=this.querySelectorAll("ul li.selected"),c=0;c<b.length;++c)a.push(b[c].dataset.name);return a};k.getByIndex=function(a){return this.querySelectorAll("ul li")[a]};k.getIndex=k.getByIndex;k.selectIndex=function(a,b){for(var c=this.querySelectorAll("ul li"),d=0;d<c.length;++d){var e=c[d];d==a?e.classList.add("selected"):b||e.classList.remove("selected")}return c[a]};
k.deselectIndex=function(a){(a=this.querySelectorAll("ul li")[a])&&a.classList.remove("selected");return a};k.scrollToIndex=function(a){if(a=this.querySelectorAll("ul li")[a])this.scrollTop=a.offsetTop};k.selectAll=function(){for(var a=this.querySelectorAll("ul li"),b=0;b<a.length;++b){var c=a[b];c.classList.contains("selected")||LiteGUI.trigger(c,"click")}};k.deselectAll=function(){for(var a=this.querySelectorAll("ul li"),b=0;b<a.length;++b){var c=a[b];c.classList.contains("selected")&&LiteGUI.trigger(c,
"click")}};k.setValue=function(a){void 0!==a&&this.updateItems(a)};k.getNumberOfItems=function(){return this.querySelectorAll("ul li").length};k.filter=function(a,b){var c=this.querySelectorAll("ul li"),d=!1;if(a&&a.constructor===String){var e=a;b&&e.toLowerCase();d=!0;a=function(a){return-1!=(b?a:a.toLowerCase()).indexOf(e)}}for(var f=0;f<c.length;++f){var g=c[f];if(a){var h=g.value;d&&null!=h&&h.constructor!==String&&(h=g.innerHTML);a(h,g,g.classList.contains("selected"))?g.style.display="":g.style.display=
"none"}else g.style.display=""}};k.selectByFilter=function(a){for(var b=this.querySelectorAll("ul li"),c=0;c<b.length;++c){var d=b[c],e=a(d.value,d,d.classList.contains("selected"));!0===e?d.classList.add("selected"):!1===e&&d.classList.remove("selected")}};b.height&&(k.scrollTop=0);this.processElement(k,b);return k};
