...
c},isCursorOverElement:function(c,a){var b=c.pageX,e=c.pageY,d=a.getBoundingClientRect();return d?e>d.top&&e<d.top+d.height&&b>d.left&&b<d.left+d.width?!0:!1:!1},getRect:function(c){return c.getBoundingClientRect()},toClipboard:function(c,a){c&&c.constructor!==String&&(c=JSON.stringify(c));var b=null,e=!1;if(!a)try{document.queryCommandSupported("copy"),b=document.createElement("input"),b.type="text",b.style.opacity=0,b.value=c,document.body.appendChild(b),b.select(),e=document.execCommand("copy"),
console.log(e?"saved to clipboard":"problem saving to clipboard"),document.body.removeChild(b)}catch(d){b&&document.body.removeChild(b),console.warn("Oops, unable to copy using the true clipboard")}try{this._safe_cliboard=null,localStorage.setItem("litegui_clipboard",c)}catch(f){this._safe_cliboard=c,console.warn("cliboard quota excedeed")}},getLocalClipboard:function(){var c=localStorage.getItem("litegui_clipboard");!c&&this._safe_cliboard&&(c=this._safe_cliboard);return c?"{"==c[0]?JSON.parse(c):
c:null},addCSS:function(c){if(c)if(c.constructor===String){var a=document.createElement("style");a.type="text/css";a.innerHTML=c;document.getElementsByTagName("head")[0].appendChild(a)}else for(a in c)document.body.style[a]=c[a]},requireCSS:function(c,a){for("string"==typeof c&&(c=[c]);c.length;){var b=document.createElement("link");b.rel="stylesheet";b.type="text/css";b.href=c.shift(1);b.media="all";document.getElementsByTagName("head")[0].appendChild(b);0==c.length&&(b.onload=a)}},request:function(c){var a=
c.dataType||"text";"json"==a?a="text":"xml"==a?a="text":"binary"==a&&(a="arraybuffer",c.mimeType="application/octet-stream");var b=new XMLHttpRequest;b.open(c.data?"POST":"GET",c.url,!0);a&&(b.responseType=a);c.mimeType&&b.overrideMimeType(c.mimeType);c.nocache&&b.setRequestHeader("Cache-Control","no-cache");b.onload=function(a){a=this.response;if(200!=this.status)a="Error "+this.status,c.error&&c.error(a),LEvent.trigger(b,"fail",this.status);else{if("json"==c.dataType)try{a=JSON.parse(a)}catch(e){if(c.error)c.error(e);
else throw e;}else if("xml"==c.dataType)try{a=(new DOMParser).parseFromString(a,"text/xml")}catch(g){if(c.error)c.error(g);else throw g;}c.success&&c.success.call(this,a,this)}};b.onerror=function(a){c.error&&c.error(a)};a=new FormData;if(c.data)for(var e in c.data)a.append(e,c.data[e]);b.send(a);return b},requestText:function(c,a,b){return this.request({url:c,dataType:"text",success:a,error:b})},requestJSON:function(c,a,b){return this.request({url:c,dataType:"json",success:a,error:b})},requestBinary:function(c,
a,b){return this.request({url:c,dataType:"binary",success:a,error:b})},requireScript:function(c,a,b,e,d){if(!c)throw"invalid URL";c.constructor===String&&(c=[c]);var f=c.length,g=[],h;for(h in c){var l=document.createElement("script");l.num=h;l.type="text/javascript";l.src=c[h]+(d?"?version="+d:"");l.original_src=c[h];l.async=!1;l.onload=function(b){f--;g.push(this);f?e&&e(this.original_src,this.num):a&&a(g)};b&&(l.onerror=function(a){b(a,this.original_src,this.num)});document.getElementsByTagName("head")[0].appendChild(l)}},
requireScriptSerial:function(c,a,b){function e(){var f=document.createElement("script");f.type="text/javascript";f.src=c.shift(1);f.onload=function(f){c.length?(b&&b(c[0],c.length),e()):(d.push(this),a&&a(d))};document.getElementsByTagName("head")[0].appendChild(f)}"string"==typeof c&&(c=[c]);var d=[];e()},newDiv:function(c,a){return this.createElement("div",c,a)},createElement:function(c,a,b,e,d){c=document.createElement(c);if(a){a=a.split(" ");for(var f=0;f<a.length;f++)"."==a[f][0]?c.classList.add(a[f].substr(1)):
c.id="#"==a[f][0]?a[f].substr(1):a[f]}c.root=c;b&&(c.innerHTML=b);c.add=function(a){this.appendChild(a.root||a)};if(e)if(e.constructor===String)c.setAttribute("style",e);else for(f in e)c.style[f]=e[f];if(d)for(f in d)c.addEventListener(f,d[f]);return c},createButton:function(c,a,b,e){var d=document.createElement("button");d.className="litegui litebutton button";if(c){c=c.split(" ");for(var f=0;f<c.length;f++)"."==c[f][0]?d.classList.add(c[f].substr(1)):d.id="#"==c[f][0]?c[f].substr(1):c[f]}d.root=
d;void 0!==a&&(d.innerHTML=a);b&&d.addEventListener("click",b);if(e)if(e.constructor===String)d.setAttribute("style",e);else for(f in e)d.style[f]=e[f];return d},getParents:function(c){for(var a=[];null!==(c=c.parentElement);)c.nodeType===Node.ELEMENT_NODE&&a.push(elem);return a},newWindow:function(c,a,b,e){e=e||{};a=window.open("","","width="+a+", height="+b+", location=no, status=no, menubar=no, titlebar=no, fullscreen=yes");a.document.write("<html><head><title>"+c+"</title>");b=document.querySelectorAll("link[rel='stylesheet'],style");
for(c=0;c<b.length;c++)a.document.write(b[c].outerHTML);if(e.scripts)for(b=document.querySelectorAll("script"),c=0;c<b.length;c++)b[c].src&&a.document.write(b[c].outerHTML);a.document.write("</head><body>"+(e.content||"")+"</body></html>");a.document.close();return a},showModalBackground:function(c){LiteGUI.modalbg_div&&(LiteGUI.modalbg_div.style.display=c?"block":"none")},showMessage:function(c,a){a=a||{};a.title=a.title||"Attention";a.content=c;a.close="fade";var b=new LiteGUI.Dialog(a);a.noclose||
b.addButton("Close",{close:!0});b.makeModal("fade");return b},popup:function(c,a){a=a||{};a.min_height=140;"string"==typeof c&&(c="<p>"+c+"</p>");a.content=c;a.close="fade";var b=new LiteGUI.Dialog(a);a.noclose||b.addButton("Close",{close:!0});b.show();return b},alert:function(c,a){a=a||{};a.className="alert";a.title=a.title||"Alert";a.width=a.width||280;a.height=a.height||140;"string"==typeof c&&(c="<p>"+c+"</p>");LiteGUI.remove(".litepanel.alert");return LiteGUI.showMessage(c,a)},confirm:function(c,
a,b){function e(b){b="yes"==this.dataset.value;d.close();a&&a(b)}b=b||{};b.className="alert";b.title=b.title||"Confirm";b.width=b.width||280;"string"==typeof c&&(c="<p>"+c+"</p>");b.noclose=!0;var d=this.showMessage(c+"<button class='litebutton' data-value='yes' style='width:45%; margin-left: 10px'>Yes</button><button class='litebutton' data-value='no' style='width:45%'>No</button>",b);d.content.style.paddingBottom="10px";c=d.content.querySelectorAll("button");for(b=0;b<c.length;b++)c[b].addEventListener("click",
e);c[0].focus();return d},prompt:function(c,a,b){function e(){var b=h.value;this.dataset&&"cancel"==this.dataset.value&&(b=null);g.close();a&&a(b)}b=b||{};b.className="alert";b.title=b.title||"Prompt";b.width=b.width||280;"string"==typeof c&&(c="<p>"+c+"</p>");var d=b.value||"",f="<input type='text' value='"+d+"'/>";b.textarea&&(f="<textarea class='textfield' style='width:95%'>"+d+"</textarea>");b.noclose=!0;var g=this.showMessage(c+("<p>"+f+"</p><button class='litebutton' data-value='accept' style='width:45%; margin-left: 10px; margin-bottom: 10px'>Accept</button><button class='litebutton' data-value='cancel' style='width:45%'>Cancel</button>"),
b);c=g.content.querySelectorAll("button");for(b=0;b<c.length;b++)c[b].addEventListener("click",e);var h=g.content.querySelector("input,textarea");h.addEventListener("keydown",function(a){a||(a=window.event);a=a.keyCode||a.which;if("13"==a)return e(),!1;"29"==a&&g.close()},!0);h.focus();return g},choice:function(c,a,b,e){function d(c){c=a[this.dataset.value];g.close();b&&b(c)}e=e||{};e.className="alert";e.title=e.title||"Select one option";e.width=e.width||280;"string"==typeof c&&(c="<p>"+c+"</p>");
for(var f in a)c+="<button class='litebutton' data-value='"+f+"' style='width:45%; margin-left: 10px'>"+(a[f].content||a[f])+"</button>";e.noclose=!0;var g=this.showMessage(c,e);g.content.style.paddingBottom="10px";c=g.content.querySelectorAll("button");for(f=0;f<c.length;f++)c[f].addEventListener("click",d);return g},downloadURL:function(c,a){var b=document.createElement("a");b.href=c;b.download=a;document.body.appendChild(b);b.click();document.body.removeChild(b)},downloadFile:function(c,a,b){if(a){b||
(b=a.constructor===String?"text/plain":"application/octet-stream");var e=null,e=a.constructor!==File&&a.constructor!==Blob?new Blob([a],{type:b}):a,d=URL.createObjectURL(e);a=document.createElement("a");a.setAttribute("href",d);a.setAttribute("download",c);a.style.display="none";document.body.appendChild(a);a.click();document.body.removeChild(a);setTimeout(function(){URL.revokeObjectURL(d)},6E4)}else console.warn("No file provided to download")},getUrlVars:function(){for(var c=[],a,b=window.location.href.slice(window.location.href.indexOf("?")+
1).split("&"),e=0;e<b.length;e++)a=b[e].split("="),c.push(a[0]),c[a[0]]=a[1];return c},getUrlVar:function(c){return LiteGUI.getUrlVars()[c]},focus:function(c){c.focus()},blur:function(c){c.blur()},draggable:function(c,a,b,e,d){function f(a){if("mousedown"==a.type){l||(k=(l=c.getClientRects()[0])?l.left:0,n=l?l.top:0);if(d&&!1==d(c,a))return a.stopPropagation(),a.preventDefault(),!1;g=a.clientX;h=a.clientY;document.addEventListener("mousemove",f);document.addEventListener("mouseup",f);b&&b(c,a);a.stopPropagation();
a.preventDefault();return!1}if("mouseup"==a.type)document.removeEventListener("mousemove",f),document.removeEventListener("mouseup",f),e&&e(c,a);else if("mousemove"==a.type){var m=a.clientX-g,q=a.clientY-h;g=a.clientX;h=a.clientY;k+=m;n+=q;c.style.left=k+"px";c.style.top=n+"px"}}a=a||c;a.addEventListener("mousedown",f);a.style.cursor="move";var g=0,h=0,l=c.getClientRects()[0],k=l?l.left:0,n=l?l.top:0;c.style.position="absolute";c.style.left=k+"px";c.style.top=n+"px"},cloneObject:function(c,a){var b=
...
refresh:"&#8634;",gear:"&#9881;",open_folder:"&#128194;",download:"&#11123;"},htmlEncode:function(c){var a=document.createElement("div");a.innerHTML=c;return a.innerText},htmlDecode:function(c){var a=document.createElement("div");a.innerText=c;return a.innerHTML},sizeToCSS:function(c){return void 0===c||null===c?null:c.constructor===String?c:0<=c?(c|0)+"px":"calc( 100% - "+Math.abs(c|0)+"px )"},getElementWindow:function(c){c=c.ownerDocument;return c.defaultView||c.parentWindow},createDropArea:function(c,
a,b,e){function d(a){c.addEventListener("dragexit",d);c.addEventListener("dragover",d);c.addEventListener("drop",f);a.stopPropagation();a.preventDefault();"dragenter"==a.type&&b&&b(a,this);"dragexit"==a.type&&e&&e(a,this)}function f(b){b.stopPropagation();b.preventDefault();c.removeEventListener("dragexit",d);c.removeEventListener("dragover",d);c.removeEventListener("drop",f);var e=void 0;a&&(e=a(b));if(e)return b.stopPropagation(),b.stopImmediatePropagation(),!0}c.addEventListener("dragenter",d)}};
Object.defineProperty(String.prototype,"template",{value:function(c,a){for(var b=this,e=/{{([^}}]+)?}}/g,d;d=e.exec(b);)var f=a?(new Function("with(this) { try { return "+d[1]+"} catch(e) { return 'error';} }")).call(c):c[d[1]],b=b.replace(d[0],f);return b},enumerable:!1});function purgeElement(c,a){var b=c.attributes,e,d;if(b)for(e=b.length-1;0<=e;e-=1)d=b[e].name,"function"===typeof c[d]&&(c[d]=null);if(b=c.childNodes)for(b=b.length,e=0;e<b;e+=1)purgeElement(c.childNodes[e])}
...
(function(){function c(a,b){b=b||{};var c=document.createElement("div");c.className="litegui searchbox";c.innerHTML="<input value='"+a+"' placeholder='"+(null!=b.placeholder?b.placeholder:"Search")+"'/>";this.input=c.querySelector("input");this.root=c;var g=this;this.input.onchange=function(a){a=a.target.value;b.callback&&b.callback.call(g,a)}}function a(a,b){function c(a){var b=parseInt(h.style.top);h.style.top=(b+0.1*a.deltaY).toFixed()+"px";a.preventDefault();return!0}this.options=b=b||{};var g=
this;b.parentMenu&&(b.parentMenu.constructor!==this.constructor?(console.error("parentMenu must be of class ContextMenu, ignoring it"),b.parentMenu=null):(this.parentMenu=b.parentMenu,this.parentMenu.lock=!0,this.parentMenu.current_submenu=this));b.event&&"MouseEvent"!==b.event.constructor.name&&"CustomEvent"!==b.event.constructor.name&&(console.error("Event passed to ContextMenu is not of type MouseEvent or CustomEvent. Ignoring it."),b.event=null);var h=document.createElement("div");h.className=
"litecontextmenu litemenubar-panel";h.style.minWidth=100;h.style.minHeight=100;h.style.pointerEvents="none";setTimeout(function(){h.style.pointerEvents="auto"},100);h.addEventListener("mouseup",function(a){a.preventDefault();return!0},!0);h.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);h.addEventListener("mousedown",function(a){if(2==a.button)return g.close(),a.preventDefault(),!0},!0);this.root=h;if(b.title){var l=document.createElement("div");
l.className="litemenu-title";l.innerHTML=b.title;h.appendChild(l)}var l=0,k;for(k in a){var n=a.constructor==Array?a[k]:k;null!=n&&n.constructor!==String&&(n=void 0===n.content?String(n):n.content);this.addItem(n,a[k],b);l++}h.addEventListener("mouseleave",function(a){g.lock||(h.closing_timer&&clearTimeout(h.closing_timer),h.closing_timer=setTimeout(g.close.bind(g,a),500))});h.addEventListener("mouseenter",function(a){h.closing_timer&&clearTimeout(h.closing_timer)});h.addEventListener("wheel",c,!0);
h.addEventListener("mousewheel",c,!0);k=document;b.event&&(k=b.event.target.ownerDocument);k||(k=document);k.body.appendChild(h);l=b.left||0;k=b.top||0;if(b.event)if("MouseEvent"!==b.event.constructor.name&&"CustomEvent"!==b.event.constructor.name)console.warn("Event passed to ContextMenu is not of type MouseEvent"),b.event=null;else{l=b.event.pageX-10;k=b.event.pageY-10;b.title&&(k-=20);b.parentMenu&&(l=b.parentMenu.root.getBoundingClientRect(),l=l.left+l.width);var n=document.body.getBoundingClientRect(),
p=h.getBoundingClientRect();l>n.width-p.width-10&&(l=n.width-p.width-10);k>n.height-p.height-10&&(k=n.height-p.height-10)}h.style.left=l+"px";h.style.top=k+"px"}function b(a,b,c){c=c||{};var g=this.root=document.createElement("ul");g.id=a;g.className="litelist";this.items=[];var h=this;this.callback=c.callback;for(var l in b){a=document.createElement("li");a.className="list-item";a.data=b[l];a.dataset.value=b[l];var k="";"string"==typeof b[l]?k=b[l]+"<span class='arrow'></span>":(k=(b[l].name||b[l].title||
"")+"<span class='arrow'></span>",b[l].id&&(a.id=b[l].id));a.innerHTML=k;a.addEventListener("click",function(){for(var a=g.querySelectorAll(".list-item.selected"),b=0;b<a.length;++b)a[b].classList.remove("selected");this.classList.add("selected");LiteGUI.trigger(h.root,"wchanged",this);h.callback&&h.callback(this.data)});g.appendChild(a)}c.parent&&(c.parent.root?c.parent.root.appendChild(g):c.parent.appendChild(g))}LiteGUI.Button=function(a,b){b=b||{};"function"===typeof b&&(b={callback:b});var c=
this,g=document.createElement("div");g.className="litegui button";this.root=g;var h=document.createElement("button");h.className="litebutton";this.content=h;g.appendChild(h);h.innerHTML=a;h.addEventListener("click",function(a){c.click()});this.click=function(){b.callback&&b.callback.call(c)}};c.prototype.setValue=function(a){this.input.value=a;this.input.onchange()};c.prototype.getValue=function(){return this.input.value};LiteGUI.SearchBox=c;a.prototype.addItem=function(a,b,c){function g(a){var b=
this.value;b&&b.has_submenu&&h.call(this,a)}function h(a){var b=this.value,e=!0;l.current_submenu&&l.current_submenu.close(a);if(c.callback){var d=c.callback.call(l,b,c,a);!0===d&&(e=!1)}if(b&&(b.callback&&!c.ignore_item_callbacks&&!0!==b.disabled&&(d=b.callback.call(this,b,c,a,l),!0===d&&(e=!1)),b.submenu)){if(!b.submenu.options)throw"ContextMenu submenu needs options";new LiteGUI.ContextMenu(b.submenu.options,{callback:b.submenu.callback,event:a,parentMenu:l,ignore_item_callbacks:b.submenu.ignore_item_callbacks,
title:b.submenu.title,autoopen:c.autoopen});e=!1}e&&!l.lock&&l.close()}var l=this;c=c||{};var k=document.createElement("div");k.className="litemenu-entry submenu";var n=!1;if(null===b)k.classList.add("separator");else{k.innerHTML=b&&b.title?b.title:a;if(k.value=b)b.disabled&&(n=!0,k.classList.add("disabled")),(b.submenu||b.has_submenu)&&k.classList.add("has_submenu");"function"==typeof b?(k.dataset.value=a,k.onclick_callback=b):k.dataset.value=b}this.root.appendChild(k);n||k.addEventListener("click",
h);c.autoopen&&k.addEventListener("mouseenter",g);return k};a.prototype.close=function(a,b){this.root.parentNode&&this.root.parentNode.removeChild(this.root);this.parentMenu&&!b&&(this.parentMenu.lock=!1,this.parentMenu.current_submenu=null,void 0===a?this.parentMenu.close():a&&!LiteGUI.isCursorOverElement(a,this.parentMenu.root)&&LiteGUI.trigger(this.parentMenu.root,"mouseleave",a));this.current_submenu&&this.current_submenu.close(a,!0);this.root.closing_timer&&clearTimeout(this.root.closing_timer)};
a.prototype.getTopMenu=function(){return this.options.parentMenu?this.options.parentMenu.getTopMenu():this};a.prototype.getFirstEvent=function(){return this.options.parentMenu?this.options.parentMenu.getFirstEvent():this.options.event};LiteGUI.ContextMenu=a;LiteGUI.ContextualMenu=a;LiteGUI.Checkbox=function(a,b){this.value=a;var c=this.root=document.createElement("span");c.className="litecheckbox inputfield";c.dataset.value=a;var g=this.element=document.createElement("span");g.className="fixed flag checkbox "+
...
function(a){for(var b=this.root.querySelectorAll(".list-item"),c=0;c<b.length;c++){var g=b[c];if(g.data==a){LiteGUI.trigger(g,"click");break}}};LiteGUI.List=b;LiteGUI.Slider=function(a,b){function c(a){var e=l.getBoundingClientRect();if(e){var f=b.min||0;k.setValue(a/e.width*((b.max||1)-f)+f)}}function g(a){var b=l.getBoundingClientRect();if(b)return c((void 0===a.x?a.pageX:a.x)-b.left),a.preventDefault(),!1}function h(a){var b=n||document;n=null;b.removeEventListener("mousemove",g);b.removeEventListener("mouseup",
h);a.preventDefault();return!1}b=b||{};var l=this.root=document.createElement("div"),k=this;this.value=a;l.className="liteslider";this.setValue=function(a,c){var e=b.min||0,f=b.max||1;a<e?a=e:a>f&&(a=f);f=(a-e)/(f-e);e=(100*f).toFixed(1)+"%";f=(100*f+2).toFixed(1)+"%";l.style.background="linear-gradient(to right, #999 "+e+", #FC0 "+f+", #333 "+f+")";if(a!=this.value&&(this.value=a,!c&&(LiteGUI.trigger(this.root,"change",a),this.onChange)))this.onChange(a)};var n=null;l.addEventListener("mousedown",
function(a){var b;a.offsetX?b=a.offsetX:a.layerX&&(b=a.layerX);c(b);n=l.ownerDocument;n.addEventListener("mousemove",g);n.addEventListener("mouseup",h);a.preventDefault();a.stopPropagation()});this.setValue(a)};LiteGUI.LineEditor=function(a,b){function c(a){return[q.width*((m.xrange[1]-m.xrange[0])*a[0]+m.xrange[0]),q.height*((m.yrange[1]-m.yrange[0])*a[1]+m.yrange[0])]}function g(a){return[(a[0]/q.width-m.xrange[0])/(m.xrange[1]-m.xrange[0]),(a[1]/q.height-m.yrange[0])/(m.yrange[1]-m.yrange[0])]}
function h(a){var b=q.getBoundingClientRect(),c=a.clientX-b.left,e=a.clientY-b.top;0>c?c=0:c>q.width&&(c=q.width);0>e?e=0:e>q.height&&(e=q.height);if(-1!=r&&n([a.clientX-b.left,a.clientY-b.top],[c,e])>0.5*q.height)m.value.splice(r,1),l(a);else{b=g([-(s[0]-c),s[1]-e]);if(-1!=r){var d=m.xrange[0],f=m.xrange[1];m.no_trespassing&&(0<r&&(d=m.value[r-1][0]),r<m.value.length-1&&(f=m.value[r+1][0]));var h=m.value[r];h[0]+=b[0];h[1]+=b[1];h[0]<d?h[0]=d:h[0]>f&&(h[0]=f);h[1]<m.yrange[0]?h[1]=m.yrange[0]:h[1]>
m.yrange[1]&&(h[1]=m.yrange[1])}p();m.redraw();s[0]=c;s[1]=e;k();a.preventDefault();a.stopPropagation()}}function l(a){r=-1;m.redraw();document.removeEventListener("mousemove",h);document.removeEventListener("mouseup",l);k();a.preventDefault();a.stopPropagation()}function k(){b.callback?b.callback.call(m,m.value):LiteGUI.trigger(m,"change")}function n(a,b){return Math.sqrt(Math.pow(b[0]-a[0],2)+Math.pow(b[1]-a[1],2))}function p(){var a=null;-1!=r&&(a=m.value[r]);m.value.sort(function(a,b){return a[0]-
b[0]});a&&(r=m.value.indexOf(a))}b=b||{};var m=document.createElement("div");m.className="curve "+(b.extraclass?b.extraclass:"");m.style.minHeight="50px";m.style.width=b.width||"100%";m.bgcolor=b.bgcolor||"#222";m.pointscolor=b.pointscolor||"#5AF";m.linecolor=b.linecolor||"#444";m.value=a||[];m.xrange=b.xrange||[0,1];m.yrange=b.yrange||[0,1];m.defaulty=null!=b.defaulty?b.defaulty:0.5;m.no_trespassing=b.no_trespassing||!1;m.show_samples=b.show_samples||0;m.options=b;m.style.minWidth="50px";m.style.minHeight=
"20px";var q=document.createElement("canvas");q.width=b.width||200;q.height=b.height||50;m.appendChild(q);m.canvas=q;m.addEventListener("mousedown",function(a){document.addEventListener("mousemove",h);document.addEventListener("mouseup",l);for(var b=q.getBoundingClientRect(),e=a.clientX-b.left,b=a.clientY-b.top,d=q.height-b,k=1E5,x=-1,u=0;u<m.value.length;u++){var t=c(m.value[u]),t=n([e,d],t);t<k&&8>t&&(k=t,x=u)}r=x;-1==r&&(d=g([e,q.height-b]),m.value.push(d),p(),r=m.value.indexOf(d));s=[e,b];m.redraw();
a.preventDefault();a.stopPropagation()});m.getValueAt=function(a){if(a<m.xrange[0]||a>m.xrange[1])return m.defaulty;for(var b=[m.xrange[0],m.defaulty],c=0,c=0;c<m.value.length;c+=1){var e=m.value[c];if(a==e[0])return e[1];if(a<e[0])return c=(a-b[0])/(e[0]-b[0]),b[1]*(1-c)+e[1]*c;b=e}e=[m.xrange[1],m.defaulty];c=(a-b[0])/(e[0]-b[0]);return b[1]*(1-c)+e[1]*c};m.resample=function(a){var b=[];a=(m.xrange[1]-m.xrange[0])/a;for(var c=m.xrange[0];c<=m.xrange[1];c+=a)b.push(m.getValueAt(c));return b};m.addValue=
function(a){for(var b=0;b<m.value;b++)if(!(m.value[b][0]<a[0])){m.value.splice(b,0,a);redraw();return}m.value.push(a);redraw()};var r=-1;m.redraw=function(){var a=q.parentNode.getBoundingClientRect();a&&q.width!=a.width&&a.width&&1E3>a.width&&(q.width=a.width);a&&q.height!=a.height&&a.height&&1E3>a.height&&(q.height=a.height);a=q.getContext("2d");a.setTransform(1,0,0,1,0,0);a.translate(0,q.height);a.scale(1,-1);a.fillStyle=m.bgcolor;a.fillRect(0,0,q.width,q.height);a.strokeStyle=m.linecolor;a.beginPath();
var b=c([m.xrange[0],m.defaulty]);a.moveTo(b[0],b[1]);for(var e in m.value)b=m.value[e],b=c(b),a.lineTo(b[0],b[1]);b=c([m.xrange[1],m.defaulty]);a.lineTo(b[0],b[1]);a.stroke();for(e=0;e<m.value.length;e+=1)b=m.value[e],b=c(b),a.fillStyle=r==e?"white":m.pointscolor,a.beginPath(),a.arc(b[0],b[1],r==e?4:2,0,2*Math.PI),a.fill();if(m.show_samples){var d=m.resample(m.show_samples);a.fillStyle="#888";for(e=0;e<d.length;e+=1)b=[(m.xrange[1]-m.xrange[0])/m.show_samples*e+m.xrange[0],d[e]],b=c(b),a.beginPath(),
a.arc(b[0],b[1],2,0,2*Math.PI),a.fill()}};var s=[0,0];m.redraw();return m}})();
...
String)throw"First parameter must be a string: 'vertical' or 'horizontal'";b||(b=["50%",null]);if("vertical"!=a&&"horizontal"!=a)throw"First parameter must be a string: 'vertical' or 'horizontal'";if(this.sections.length)throw"cannot split twice";var h=new LiteGUI.Area({content_id:this.content.id});h.root.style.display="inline-block";var l=new LiteGUI.Area;l.root.style.display="inline-block";var k="",n=null,p=null;e&&(k=" - "+(c.splitbar_size+2)+"px",n=document.createElement("div"),n.className="litesplitbar "+
a,"vertical"==a?n.style.height=c.splitbar_size+"px":n.style.width=c.splitbar_size+"px",this.splitbar=n,n.addEventListener("mousedown",d));b=b||["50%",null];"vertical"==a?(h.root.style.width="100%",l.root.style.width="100%",null==b[0]?(p=b[1],"number"==typeof p&&(p=b[1]+"px"),h.root.style.height="-moz-calc( 100% - "+p+k+" )",h.root.style.height="-webkit-calc( 100% - "+p+k+" )",h.root.style.height="calc( 100% - "+p+k+" )",l.root.style.height=p,l.size=p,p=h):null==b[1]?(p=b[0],"number"==typeof p&&(p=
b[0]+"px"),h.root.style.height=p,h.size=p,l.root.style.height="-moz-calc( 100% - "+p+k+" )",l.root.style.height="-webkit-calc( 100% - "+p+k+" )",l.root.style.height="calc( 100% - "+p+k+" )",p=l):(k=b[0],"number"==typeof k&&(k=b[0]+"px"),e=b[1],"number"==typeof e&&(e=b[1]+"px"),h.root.style.height=k,h.size=k,l.root.style.height=e,l.size=e)):(h.root.style.height="100%",l.root.style.height="100%",null==b[0]?(p=b[1],"number"==typeof p&&(p=b[1]+"px"),h.root.style.width="-moz-calc( 100% - "+p+k+" )",h.root.style.width=
"-webkit-calc( 100% - "+p+k+" )",h.root.style.width="calc( 100% - "+p+k+" )",l.root.style.width=p,l.size=b[1],p=h):null==b[1]?(p=b[0],"number"==typeof p&&(p=b[0]+"px"),h.root.style.width=p,h.size=p,l.root.style.width="-moz-calc( 100% - "+p+k+" )",l.root.style.width="-webkit-calc( 100% - "+p+k+" )",l.root.style.width="calc( 100% - "+p+k+" )",p=l):(k=b[0],"number"==typeof k&&(k=b[0]+"px"),e=b[1],"number"==typeof e&&(e=b[1]+"px"),h.root.style.width=k,h.size=k,l.root.style.width=e,l.size=e));h.root.removeChild(h.content);
h.root.appendChild(this.content);h.content=this.content;this.root.appendChild(h.root);n&&this.root.appendChild(n);this.root.appendChild(l.root);this.sections=[h,l];this.dynamic_section=p;this.direction=a;var m=this,q=[0,0]};c.prototype.hide=function(){this.root.style.display="none"};c.prototype.show=function(){this.root.style.display="block"};c.prototype.showSection=function(a){var b=this.sections[a],c=0;if(!b||"none"==b.root.style.display){c="horizontal"==this.direction?b.root.style.width:b.root.style.height;
...
c.prototype.add=function(a,b){b=b||{};"function"==typeof b&&(b={callback:b});for(var c=this.menu.length,d=a.split("/"),f=0,g=0,h=this.menu,l=null;h;){if(5<f)throw"Error: Menubar too deep";if(h.length==g){l=g={parent:l,children:[]};f==d.length-1&&(g.data=b);g.disable=function(){this.data&&(this.data.disabled=!0)};g.enable=function(){this.data&&delete this.data.disabled};g.name=d[f];h.push(g);f++;if(f==d.length)break;g.children=[];h=g.children;g=0}else{if(h[g]&&d[f]==h[g].name)if(f<d.length-1){l=h[g];
...
a.children.length){var f=this;f.closing_by_leave&&clearInterval(f.closing_by_leave);var g=document.createElement("div");g.className="litemenubar-panel";var h=[],l;for(l in a.children)h.push(a.children[l]);this.sort_entries&&h.sort(function(a,b){var c=10,e=10;a&&a.data&&null!=a.data.order&&(c=a.data.order);a&&a.separator&&null!=a.order&&(c=a.order);b&&b.data&&null!=b.data.order&&(e=b.data.order);b&&b.separator&&null!=b.order&&(e=b.order);return c-e});for(l in h){a=document.createElement("p");var k=
h[l];a.className="litemenu-entry "+(a.children?" submenu":"");var n=k.children&&k.children.length;n&&a.classList.add("has_submenu");k&&k.name?a.innerHTML="<span class='icon'></span><span class='name'>"+k.name+(n?"<span class='more'>+</span>":"")+"</span>":a.classList.add("separator");a.data=k;if(a.data.data){k=a.data.data;if("checkbox"==k.type&&k.instance&&k.property&&!0==k.instance[k.property]||!0==k.checkbox||k.instance&&k.property&&k.hasOwnProperty("value")&&k.instance[k.property]==k.value||"function"==
typeof k.isChecked&&k.isChecked.call(k.instance,k))a.className+=" checked";k.disabled&&(a.className+=" disabled")}a.addEventListener("click",function(){var a=this.data;if(a.data){if(a.data.disabled)return;a.data.instance&&a.data.property&&("checkbox"==a.data.type?(a.data.instance[a.data.property]=!a.data.instance[a.data.property],a.data.instance[a.data.property]?this.classList.add("checked"):this.classList.remove("checked")):a.data.hasOwnProperty("value")&&(a.data.instance[a.data.property]=a.data.value));
...
b.selectTab(a)}};c.prototype.detachTab=function(a,b,c){if(this.tabs[a]){var d=this.getTabIndex(a),f=window.open("","","width=800, height=600, location=no, status=no, menubar=no, titlebar=no, fullscreen=yes");f.document.write("<head><title>"+a+"</title>");for(var g=document.querySelectorAll("link[rel='stylesheet'],style"),h=0;h<g.length;h++)f.document.write(g[h].outerHTML);f.document.write("</head><body></body>");f.document.close();var l=this,k=new LiteGUI.Tabs(null,this.options);f.tabs=k;f.onbeforeunload=
function(){k.transferTab(a,l,d);c&&c()};k.list.style.height="20px";f.document.body.appendChild(k.root);l.transferTab(a,k);k.tabs[a].tab.classList.add("selected");this.recomputeTabsByIndex();b&&b();return f}};LiteGUI.Tabs=c})();
(function(){function c(a,b){function c(a){var e=[a.screenX-m.data[0],m.data[1]-a.screenY];void 0!==a.movementX&&(e=[a.movementX,-a.movementY]);m.data=[a.screenX,a.screenY];g(e[b.horizontal?0:1],a);a.stopPropagation();a.preventDefault();return!1}function d(a){document.activeElement===this&&(g(0<(void 0!==a.wheelDelta?a.wheelDelta:a.deltaY?-a.deltaY/3:0)?1:-1,a),a.stopPropagation(),a.preventDefault())}function f(a){LiteGUI.trigger(l,"stop_dragging");var b=q||document;q=null;b.removeEventListener("mousemove",
c);b.removeEventListener("mouseup",f);b.exitPointerLock&&b.exitPointerLock();LiteGUI.trigger(m,"blur");a.stopPropagation();a.preventDefault();return!1}function g(a,c){b.linear||(a=0<a?Math.pow(a,1.2):-1*Math.pow(Math.abs(a),1.2));var e=b.step?b.step:1;c&&c.shiftKey?e*=10:c&&c.ctrlKey&&(e*=0.1);e=parseFloat(p.value)+a*e;null!=b.max&&e>b.max&&(e=b.max);null!=b.min&&e<b.min&&(e=b.min);p.value=e.toFixed(h);b.units&&(p.value+=b.units);LiteGUI.trigger(p,"change")}null===a||void 0===a?a=0:a.constructor===
String?a=parseFloat(a):a.constructor!==Number&&(a=0);this.value=a;var h=void 0!=b.precision?b.precision:3;this.options=b||{};var l=document.createElement("div");l.className="dragger "+(b.extraclass?b.extraclass:"");this.root=l;var k=document.createElement("span");k.className="inputfield "+(b.extraclass?b.extraclass:"")+(b.full?" full":"");b.disabled&&(k.className+=" disabled");l.appendChild(k);var n=b.dragger_class||"full",p=document.createElement("input");p.className="text number "+(n?n:"");p.value=
a.toFixed(h)+(b.units?b.units:"");p.tabIndex=b.tab_index;this.input=p;l.input=p;b.disabled&&(p.disabled=!0);b.tab_index&&(p.tabIndex=b.tab_index);k.appendChild(p);p.addEventListener("keydown",function(a){if(38==a.keyCode)g(1,a);else if(40==a.keyCode)g(-1,a);else return;a.stopPropagation();a.preventDefault();return!0});var m=document.createElement("div");m.className="drag_widget";b.disabled&&(m.className+=" disabled");k.appendChild(m);l.dragger=m;m.addEventListener("mousedown",function(a){q=p.ownerDocument;
q.removeEventListener("mousemove",c);q.removeEventListener("mouseup",f);b.disabled||(l.requestPointerLock&&l.requestPointerLock(),q.addEventListener("mousemove",c),q.addEventListener("mouseup",f),m.data=[a.screenX,a.screenY],LiteGUI.trigger(l,"start_dragging"));a.stopPropagation();a.preventDefault()});p.addEventListener("wheel",d,!1);p.addEventListener("mousewheel",d,!1);var q=null}c.prototype.setRange=function(a,b){this.options.min=a;this.options.max=b};c.prototype.setValue=function(a,b){this.value=
...
1);var l=this.createTreeItem(a,b,h);if(l){l.parent_id=c;this.getItem(l.dataset.item_id)&&console.warn("There another item with the same ID in this tree");-1==f?this.root.appendChild(l):this._insertInside(l,f,d);g&&!this._isNodeChildrenVisible(c)&&l.classList.add("hidden");if(a.children)for(c=0;c<a.children.length;++c)this.createAndInsert(a.children[c],b,a.id);this._updateListBox(l,b,h);b&&b.selected&&this.markAsSelected(l,!0);return l}};c.prototype._insertInside=function(a,b,e,d){var f=this.root.childNodes[b];
...
this.getAncestors(c.parent_id,b)):b};c.prototype.isAncestor=function(a,b){var c=this.getItem(a);if(!c)return!1;var d=this.getItem(b);return(c=this.getItem(c.parent_id))?c==d?!0:this.isAncestor(c,b):!1};c.prototype.moveItem=function(a,b){if(a===b)return!1;var c=this.getItem(a),d=this.getItem(b);if(this.isAncestor(d,c))return!1;var f=this._findElementIndex(d),g=parseInt(d.dataset.level),h=this.getParent(c);if(!h)return console.error("node parent not found by id, maybe id has changed"),!1;var l=parseInt(h.dataset.level),
f=g-l;if(!d||!c||d==h)return!1;c.parent_id=b;if(g=this.getChildren(c)){g.unshift(c);for(c=0;c<g.length;c++)g[c].parentNode.removeChild(g[c]);for(c=0;c<g.length;c++){var l=g[c],k=parseInt(l.dataset.level)+f;l.dataset.level=k}f=this._findElementIndex(d);k=this._findElementLastChildIndex(f);-1==k&&(k=0);for(c=0;c<g.length;c++)l=g[c],this._insertInside(l,f,k+c-1,parseInt(l.dataset.level))}this._updateListBox(d);h&&this._updateListBox(h);return!0};c.prototype.removeItem=function(a,b){var c=a;"string"==
...
Inspector.prototype.appendTo=function(c,a){c&&(c.constructor===String&&(c=document.querySelector(c)),c&&(a?c.insertBefore(this.root,c.firstChild):c.appendChild(this.root)))};
...
Inspector.prototype.inspectInstance=function(c,a,b,e){function d(a,b){b=b||{};for(var c in a)b[c]=a[c];return b}if(c){a||(a=c.getProperties?c.getProperties():this.collectProperties(c));var f=c.constructor;!b&&f.properties&&(b=f.properties);var g={};if(c.getInspectorProperties)g=c.getInspectorProperties();else for(var h in a)if(b&&b[h])g[h]=d(b[h]);else{var l=a[h];if(f["@"+h])(l=f["@"+h])&&null===l.widget||(g[h]=d(l));else if(c["@"+h])g[h]=c["@"+h];else if(null!==l&&void 0!==l)switch(l.constructor){case Number:g[h]=
{type:"number",step:0.1};break;case String:g[h]={type:"string"};break;case Boolean:g[h]={type:"boolean"};break;default:if(l&&l.length){var k=null!=l[0]&&l[0].constructor===Number;switch(l.length){case 2:g[h]={type:k?"vec2":"Array",step:0.1};break;case 3:g[h]={type:k?"vec3":"Array",step:0.1};break;case 4:g[h]={type:k?"vec4":"Array",step:0.1};break;default:g[h]={type:"Array"}}}}}if(e)for(h in e)delete g[e[h]];if(f.properties_order){a={};for(h in f.properties_order)b=f.properties_order[h],g[b]?a[b]=
g[b]:console.warn("property not found in instance:",b);for(h in g)a[h]||(a[h]=g[h]);g=a}return this.showProperties(c,g)}};Inspector.prototype.collectProperties=function(c){var a={},b;for(b in c)if("_"!=b[0]&&"@"!=b[0]&&"jQuery"!=b.substr(0,6)){var e=c[b];if(!e||e.constructor!=Function||c.constructor["@"+b])a[b]=e}return a};
...
f+" - 0px); '",f="style='width: calc( 100% - "+f+"); width: -webkit-calc(100% - "+f+"); width: -moz-calc( 100% - "+f+"); '");b.name_width&&(d="style='width: "+LiteGUI.sizeToCSS(b.name_width)+" '");b.content_width&&(f="style='width: "+LiteGUI.sizeToCSS(b.content_width)+" '");var g="",h="",l=this.one_line?"":"<span class='filling'></span>";b.pretitle&&(h=b.pretitle);var k="wcontent ",n=c;b.title&&(n=b.title);null===c||void 0===c?k+=" full":g=""===c?g+("<span class='wname' title='"+n+"' "+d+">"+h+"</span>"):
g+("<span class='wname' title='"+n+"' "+d+">"+h+c+l+"</span>");a.constructor===String||a.constructor===Number||a.constructor===Boolean?e.innerHTML=g+"<span class='info_content "+k+"' "+f+">"+a+"</span>":(e.innerHTML=g+"<span class='info_content "+k+"' "+f+"></span>",(c=e.querySelector("span.info_content"))&&c.appendChild(a));e.content=e.querySelector("span.info_content");e.remove=function(){this.parentNode&&this.parentNode.removeChild(this)};return e};
...
Inspector.prototype.addVector2=function(c,a,b){function e(a){this.callback_before&&this.callback_before(a)}b=this.processOptions(b);b.step||(b.step=0.1);a=a||[0,0];var d=this;this.values[c]=a;var f=this.createWidget(c,"",b);b.step=b.step||0.1;b.tab_index=this.tab_index;b.full=!0;this.tab_index++;var g=f.querySelector(".wcontent"),h=new LiteGUI.Dragger(a[0],b);h.root.style.marginLeft=0;h.root.style.width="calc( 50% - 1px )";g.appendChild(h.root);b.tab_index=this.tab_index;this.tab_index++;var l=new LiteGUI.Dragger(a[1],
b);l.root.style.width="calc( 50% - 1px )";g.appendChild(l.root);f.draggers=[h,l];LiteGUI.bind(h.root,"start_dragging",e.bind(b));LiteGUI.bind(l.root,"start_dragging",e.bind(b));var k=f.querySelectorAll("input");for(a=0;a<k.length;++a)k[a].addEventListener("change",function(a){a=[];for(var e=0;e<k.length;e++)a.push(parseFloat(k[e].value));LiteGUI.trigger(f,"wbeforechange",[a]);d.values[c]=a;if(b.callback){var g=b.callback.call(f,a);if("object"==typeof g&&2<=g.length){for(e=0;e<k.length;e++)k[e].value=
g[e];a=g}}LiteGUI.trigger(f,"wchange",[a]);if(d.onchange)d.onchange(c,a,f)});this.append(f,b);f.setValue=function(a,b){a&&(h.getValue()!=a[0]&&h.setValue(a[0],!0),l.getValue()!=a[1]&&l.setValue(a[1],b))};f.setRange=function(a,b){h.setRange(a,b);l.setRange(a,b)};this.processElement(f,b);return f};
...
b);h.root.style.width="calc( 33% - 1px )";f.querySelector(".wcontent").appendChild(h.root);b.tab_index=this.tab_index;this.tab_index++;var l=new LiteGUI.Dragger(a[2],b);l.root.style.width="calc( 33% - 1px )";f.querySelector(".wcontent").appendChild(l.root);f.draggers=[g,h,l];g.root.addEventListener("start_dragging",e.bind(b));h.root.addEventListener("start_dragging",e.bind(b));l.root.addEventListener("start_dragging",e.bind(b));var k=f.querySelectorAll("input");for(a=0;a<k.length;++a)k[a].addEventListener("change",
function(a){a=[];for(var e=0;e<k.length;e++)a.push(parseFloat(k[e].value));LiteGUI.trigger(f,"wbeforechange",[a]);d.values[c]=a;if(b.callback){var g=b.callback.call(f,a);if("object"==typeof g&&3<=g.length){for(e=0;e<k.length;e++)k[e].value=g[e];a=g}}LiteGUI.trigger(f,"wchange",[a]);if(d.onchange)d.onchange(c,a,f)});this.append(f,b);f.setValue=function(a,b){a&&(g.setValue(a[0],!0),h.setValue(a[1],!0),l.setValue(a[2],b))};f.setRange=function(a,b){g.setRange(a,b);h.setRange(a,b);l.setRange(a,b)};this.processElement(f,
b);return f};
Inspector.prototype.addVector4=function(c,a,b){function e(a){this.callback_before&&this.callback_before()}b=this.processOptions(b);b.step||(b.step=0.1);a=a||[0,0,0];var d=this;this.values[c]=a;var f=this.createWidget(c,"",b);b.step=b.step||0.1;b.tab_index=this.tab_index;b.full=!0;this.tab_index++;for(var g=f.draggers=[],h=0;4>h;h++){var l=new LiteGUI.Dragger(a[h],b);l.root.style.marginLeft=0;l.root.style.width="calc( 25% - 1px )";f.querySelector(".wcontent").appendChild(l.root);b.tab_index=this.tab_index;
this.tab_index++;l.root.addEventListener("start_dragging",e.bind(b));g.push(l)}for(var k=f.querySelectorAll("input"),h=0;h<k.length;++h)k[h].addEventListener("change",function(a){a=[];for(var e=0;e<k.length;e++)a.push(parseFloat(k[e].value));LiteGUI.trigger(f,"wbeforechange",[a]);d.values[c]=a;if(b.callback){var g=b.callback.call(f,a);if("object"==typeof g&&4<=g.length){for(e=0;e<k.length;e++)k[e].value=g[e];a=g}}LiteGUI.trigger(f,"wchange",[a]);if(d.onchange)d.onchange(c,a,f)});this.append(f,b);
...
Inspector.prototype.addPad=function(c,a,b){b=this.processOptions(b);b.step||(b.step=0.1);a=a||[0,0];var e=this;this.values[c]=a;var d=this.createWidget(c,"",b);b.step=b.step||0.1;b.tab_index=this.tab_index;b.full=!0;this.tab_index++;var f=b.minx||b.min||0,g=b.miny||b.min||0,h=b.maxx||b.max||1,l=b.maxy||b.max||1,k=d.querySelector(".wcontent"),n=document.createElement("div");n.className="litepad";k.appendChild(n);n.style.width="100%";n.style.height="100px";b.background&&(n.style.backgroundImage="url('"+
b.background+"')",n.style.backgroundSize="100%",n.style.backgroundRepeat="no-repeat");var p=document.createElement("div");p.className="litepad-handler";n.appendChild(p);b.tab_index=this.tab_index;this.tab_index++;n._onMouseEvent=function(a){var k=n.getBoundingClientRect();a.mousex=a.pageX-k.left;a.mousey=a.pageY-k.top;a.preventDefault();a.stopPropagation();if("mousedown"==a.type)document.body.addEventListener("mousemove",n._onMouseEvent),document.body.addEventListener("mouseup",n._onMouseEvent);else if("mousemove"==
a.type){var r=a.mousex/k.width;a=a.mousey/k.height;r=r*(h-f)+f;a=a*(l-g)+f;r=[r,a];LiteGUI.trigger(d,"wbeforechange",[r]);d.setValue(r);if(b.callback&&(a=b.callback.call(d,r))&&2<=a.length)for(k=0;k<elems.length;k++)d.setValue(a);LiteGUI.trigger(d,"wchange",[r]);if(e.onchange)e.onchange(c,r,d)}else"mouseup"==a.type&&(document.body.removeEventListener("mousemove",n._onMouseEvent),document.body.removeEventListener("mouseup",n._onMouseEvent));return!0};n.addEventListener("mousedown",n._onMouseEvent);
d.setValue=function(a,b){if(void 0!==a){var c=n.getBoundingClientRect(),d=(a[0]-f)/(h-f),e=(a[1]-g)/(l-g),d=Math.max(0,Math.min(d,1)),e=Math.max(0,Math.min(e,1)),k=(c.height-10)/c.height*100;p.style.left=((c.width-10)/c.width*d*100).toFixed(1)+"%";p.style.top=(e*k).toFixed(1)+"%"}};this.append(d,b);d.setValue(a);this.processElement(d,b);return d};
...
Inspector.prototype.addCombo=function(c,a,b){function e(b,c){b||(b=[]);g=b;c&&(a=c);var d="",e=0,h;for(h in g){var l=g[h],s=g.constructor===Array?e:h,w=g.constructor===Array?l:h;l&&l.title&&(w=l.title);d+="<option value='"+s+"' "+(l==a?" selected":"")+" data-index='"+s+"'>"+w+"</option>";e++}f.querySelector("select").innerHTML=d}b=this.processOptions(b);var d=this;this.values[c]=a;this.tab_index++;var f=this.createWidget(c,"<span class='inputfield full inputcombo "+(b.disabled?"disabled":"")+"'></span>",
b);f.options=b;var g=b.values||[];g.constructor===Function&&(g=b.values());var h="<select tabIndex='"+this.tab_index+"' "+(b.disabled?"disabled":"")+" class='"+(b.disabled?"disabled":"")+"'></select>";f.querySelector("span.inputcombo").innerHTML=h;e(g);var l=!1;f.querySelector(".wcontent select").addEventListener("change",function(e){a=g[e.target.value];l||Inspector.onWidgetChange.call(d,f,c,a,b)});f.getValue=function(){return a};f.setValue=function(b,c){if(void 0!==b){a=b;var d=f.querySelector("select"),
e=d.querySelectorAll("option"),h=-1;if(g.constructor===Array)h=g.indexOf(b);else{var r=0,s;for(s in g)if(g[r]==b){h=r;break}else r++}if(-1!=h){l=c;for(s in e)(r=e[s])&&r.dataset&&(parseFloat(r.dataset.index)==h?(r.setAttribute("selected",!0),d.selectedIndex=h):r.removeAttribute("selected"));l=!1}}};f.setOptionValues=e;this.append(f,b);this.processElement(f,b);return f};
...
Inspector.prototype.addList=function(c,a,b){function e(c){var d=k.querySelector("li.selected");if(d){if(13==c.keyCode){if(!d)return;d=a[d.dataset.pos];b.callback_dblclick&&b.callback_dblclick.call(h,d)}else if(40==c.keyCode){var e=d.nextSibling;e&&LiteGUI.trigger(e,"click");d.scrollIntoViewIfNeeded&&d.scrollIntoViewIfNeeded({block:"end",behavior:"smooth"})}else if(38==c.keyCode)(e=d.previousSibling)&&LiteGUI.trigger(e,"click"),d.scrollIntoViewIfNeeded&&d.scrollIntoViewIfNeeded({block:"end",behavior:"smooth"});
else return;c.preventDefault();c.stopPropagation();return!0}}function d(d){if(b.multiselection)this.classList.toggle("selected");else{d=k.querySelectorAll("li");for(var e=0;e<d.length;++e)d[e].classList.remove("selected");this.classList.add("selected")}d=a[this.dataset.pos];Inspector.onWidgetChange.call(h,k,c,d,b);LiteGUI.trigger(k,"wadded",d)}function f(c){c=a[this.dataset.pos];b.callback_dblclick&&b.callback_dblclick.call(h,c)}function g(a,c,e){var g=e;c=!!c;var h=null,l="";null!=a&&(a.constructor===
String||a.constructor===Number||a.constructor===Boolean?g=String(a):a&&(g=a.content||a.title||a.name||e,h=a.style,a.icon&&(l="<img src='"+a.icon+"' class='icon' /> "),a.selected&&(c=!0)));var k;k=g.replace(/<(?:.|\n)*?>/gm,"");var n=document.createElement("li");n.classList.add("item-"+LiteGUI.safeName(e));c&&n.classList.add("selected");n.dataset.name=k;n.dataset.pos=e;n.value=a;h&&n.setAttribute("style",h);n.innerHTML=l+g;n.addEventListener("click",d);b.callback_dblclick&&n.addEventListener("dblclick",
f);return n}b=this.processOptions(b);var h=this,l="";b.height&&(l="style='height: 100%; overflow: auto;'");l="<ul class='lite-list' "+l+" tabIndex='"+this.tab_index+"'><ul>";this.tab_index++;var k=this.createWidget(c,"<span class='inputfield full "+(b.disabled?"disabled":"")+"' style='height: 100%;'>"+l+"</span>",b);k.querySelector(".info_content").style.height="100%";k.querySelector(".lite-list");l=k.querySelector(".inputfield");l.style.height="100%";l.style.paddingBottom="0.2em";for(var l=k.querySelectorAll("ul"),
n=0;n<l.length;++n){var p=l[n];p.addEventListener("focus",function(){document.addEventListener("keydown",e,!0)});p.addEventListener("blur",function(){document.removeEventListener("keydown",e,!0)})}k.updateItems=function(c,e){e=e||b.selected;a=c;var f=this.querySelector("ul");f.innerHTML="";if(a)for(var h in a){var l=g(a[h],e,h);f.appendChild(l)}LiteGUI.bind(f.querySelectorAll("li"),"click",d)};k.addItem=function(b,c,d){a.constructor!==Array?console.error("cannot add item to list of object, only array"):
(a.push(b),d=this.querySelector("ul"),b=g(b,c),d.appendChild(b))};k.removeItem=function(a){for(var b=k.querySelectorAll(".wcontent li"),c=0;c<b.length;c++)b[c].dataset.name==a&&LiteGUI.remove(b[c])};k.updateItems(a,b.selected);this.append(k,b);k.getSelected=function(){for(var a=[],b=this.querySelectorAll("ul li.selected"),c=0;c<b.length;++c)a.push(b[c].dataset.name);return a};k.getByIndex=function(a){return this.querySelectorAll("ul li")[a]};k.getIndex=k.getByIndex;k.selectIndex=function(a,b){for(var c=
this.querySelectorAll("ul li"),d=0;d<c.length;++d){var e=c[d];d==a?e.classList.add("selected"):b||e.classList.remove("selected")}return c[a]};k.deselectIndex=function(a){(a=this.querySelectorAll("ul li")[a])&&a.classList.remove("selected");return a};k.scrollToIndex=function(a){if(a=this.querySelectorAll("ul li")[a])this.scrollTop=a.offsetTop};k.selectAll=function(){for(var a=this.querySelectorAll("ul li"),b=0;b<a.length;++b){var c=a[b];c.classList.contains("selected")||LiteGUI.trigger(c,"click")}};
k.deselectAll=function(){for(var a=this.querySelectorAll("ul li"),b=0;b<a.length;++b){var c=a[b];c.classList.contains("selected")&&LiteGUI.trigger(c,"click")}};k.setValue=function(a){void 0!==a&&this.updateItems(a)};k.getNumberOfItems=function(){return this.querySelectorAll("ul li").length};k.filter=function(a,b){var c=this.querySelectorAll("ul li"),d=!1;if(a&&a.constructor===String){var e=a;b&&e.toLowerCase();d=!0;a=function(a){return-1!=(b?a:a.toLowerCase()).indexOf(e)}}for(var f=0;f<c.length;++f){var g=
c[f];if(a){var h=g.value;d&&null!=h&&h.constructor!==String&&(h=g.innerHTML);a(h,g,g.classList.contains("selected"))?g.style.display="":g.style.display="none"}else g.style.display=""}};k.selectByFilter=function(a){for(var b=this.querySelectorAll("ul li"),c=0;c<b.length;++c){var d=b[c],e=a(d.value,d,d.classList.contains("selected"));!0===e?d.classList.add("selected"):!1===e&&d.classList.remove("selected")}};b.height&&(k.scrollTop=0);this.processElement(k,b);return k};
...
Inspector.prototype.addIcon=function(c,a,b){b=this.processOptions(b);a=a||"";var e=this,d=b.image,f=b.width||b.size||20,g=b.height||b.size||20,h=this.createWidget(c,"<span class='icon' "+(b.title?"title='"+b.title+"'":"")+" tabIndex='"+this.tab_index+"'></span>",b);this.tab_index++;var l=h.querySelector("span.wcontent"),k=h.querySelector("span.icon"),n=b.x||0;b.index&&(n=b.index*-f);h.style.minWidth=h.style.width=f+"px";h.style.margin="0 2px";h.style.padding="0";l.style.margin="0";l.style.padding=
"0";k.style.display="inline-block";k.style.cursor="pointer";k.style.width=f+"px";k.style.height=g+"px";k.style.backgroundImage="url('"+d+"')";k.style.backgroundPosition=n+"px "+(a?g:0)+"px";k.addEventListener("mousedown",function(d){d.preventDefault();a=!a;d=Inspector.onWidgetChange.call(e,h,c,a,b);LiteGUI.trigger(h,"wclick",a);void 0!==d&&(a=d);k.style.backgroundPosition=n+"px "+(a?g:0)+"px";!1===b.toggle&&setTimeout(function(){k.style.backgroundPosition=n+"px 0px";a=!1},200)});this.append(h,b);
h.setValue=function(d,f){void 0!==d&&(a=d,k.style.backgroundPosition=n+"px "+(a?g:0)+"px",f||Inspector.onWidgetChange.call(e,h,c,a,b))};h.getValue=function(){return a};this.processElement(h,b);return h};
...
callback:d.bind({value:this.value,index:e})};if(b.data_options)for(var s in b.data_options)l[s]=b.data_options[s];f.add(g,null,k,l)}f.widgets_per_row-=1}function d(a){this.value[this.index]=a;b.callback&&b.callback.call(l,this.value,this.index)}var f=this;if(a&&a.constructor===Array){b=this.processOptions(b);var g=b.data_type||"string",h=b.max_items||100,l=null;this.widgets_per_row=3;this.addInfo(c,null,{name_width:"100%",width:"100% - 160px"});var k=this.addString("length",a.length||"0",{width:100,
callback:function(b){b=parseInt(b);0>a&&(a=0);a.length=b;e.call(l)}});this.addButtons(null,["+","-"],{width:60,callback:function(b){"+"==b?a.length+=1:0<a.length&&(a.length-=1);k.setValue(a.length);e.call(l)}});this.widgets_per_row=1;l=this.addContainer(c,b);l.value=a;e.call(l);l.setValue=function(a){this.value=a;e.call(l)};l.getValue=function(){return this.value=v};return l}console.error("Inspector: Array widget value must be a valid array")};
